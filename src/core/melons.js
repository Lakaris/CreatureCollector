...
/** The ascension melon matching a creature's rarity (common/epic/legendary
 * each have their own currency). Falls back to the legendary melon for any
 * unexpected rarity value. */

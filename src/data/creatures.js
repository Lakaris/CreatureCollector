...
export const CREATURES=[
  {id:"emberpup",name:"Emberpup",emoji:"🐶",type:"Fire",rarity:"common",description:"A scrappy fire pup that chases its own tail, sometimes igniting it.",
   stats:{hp:43,atk:37,def:25,spd:1,abilitySpeed:1},
   abilities:{
     ...
     special:{name:"Tail Spin",charge:12,upgrades:["Hits nearby foes for 12 damage","Hits for 17 damage","Hits for 22 damage","Hits for 28 damage","Knocks all nearby foes airborne briefly"]},
  ...
  {id:"emberhound",name:"Emberhound",emoji:"🔥",type:"Fire",rarity:"common",description:"Emberpup fully grown. Mane is permanently on fire. Still chases its tail.",
   stats:{hp:72,atk:62,def:44,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Spark Bite",upgrades:["Deals 10 fire damage","Deals 14 fire damage","Deals 18 fire damage","Deals 23 fire damage","Burns target for 4s, dealing 5 dmg/s"]},
     special:{name:"Tail Spin",charge:12,upgrades:["Hits nearby foes for 12 damage","Hits for 17 damage","Hits for 22 damage","Hits for 28 damage","Knocks all nearby foes airborne briefly"]},
  ...
  {id:"leafling",name:"Sprighorn",emoji:"🦕",type:"Nature",rarity:"common",description:"A triceratops hatchling whose three horns are still soft green shoots. It practices charging by headbutting flowerpots.",
   stats:{hp:49,atk:40,def:27,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Sprout Jab",upgrades:["9 dmg","12 dmg","15 dmg","19 dmg","25% chance to Slow 1.5s"]},
     special:{name:"Tiny Trample",charge:10,upgrades:["Charge; 28 dmg","36 dmg","45 dmg","56 dmg","Knocks the target back 1 tile"]},
     unique:{name:"Budding Frill",upgrades:["Passive: reduce dmg taken 3","Reduce 5","Reduce 7","Reduce 10","Reduce 13; attackers take 8 thorn dmg"]}
   },role:"Attacker",attackType:"Melee",shardsToAscend:5,ascensionsToEvolve:15,evolutionId:"canoparch"},
  {id:"canoparch",name:"Thickethorn",emoji:"🦏",type:"Nature",rarity:"common",description:"Its shoots have hardened into a hedge of horns. Fences regard it as a natural predator.",
   stats:{hp:76,atk:63,def:43,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Horn Ram",upgrades:["14 dmg","18 dmg","23 dmg","29 dmg","Knocks back 1 tile"]},
     special:{name:"Thicket Charge",charge:10,upgrades:["Charge through; 42 dmg to everything in the path","52 dmg","65 dmg","80 dmg","Also Roots each foe hit 1s"]},
     unique:{name:"Bramble Frill",upgrades:["Passive: attackers take 10 thorn dmg","Thorns 14","Thorns 18","Thorns 24","Thorns 30; thorns also Slow 15% 1.5s"]}
  ...
  {id:"pebbit",name:"Pebbit",emoji:"🐸",type:"Earth",rarity:"common",description:"A round little rock frog with a pebble-smooth hide. Surprisingly difficult to step on.",
   stats:{hp:63,atk:31,def:46,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"bouldrath",name:"Bouldroad",emoji:"🐸",type:"Earth",rarity:"common",description:"Pebbit grown into a stout toad that hauls a boulder on its back. It refuses to explain why.",
   stats:{hp:112,atk:56,def:82,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Pebble Spit",upgrades:["9 dmg","10 dmg","11 dmg","12 dmg","13 dmg"]},
     special:{name:"Boulder Hunker",charge:18,upgrades:["Taunt all nearby enemies and gain a Shield equal to 3% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 6% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 9% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 12% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 15% of this creature's Defense"]},
     unique:{name:"Stone Skin",upgrades:["Debuffs expire 10% faster","Debuffs expire 20% faster","Debuffs expire 30% faster","Debuffs expire 40% faster","Debuffs expire 50% faster"]}
  ...
  {id:"galestride",name:"Galestride",emoji:"🌪️",type:"Wind",rarity:"common",description:"A fully grown Breezekit that leaves mini-tornadoes as footprints.",
   stats:{hp:63,atk:54,def:38,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Gust Swipe",upgrades:["10 dmg","11 dmg","12 dmg","13 dmg","13 dmg and inflict Defense Down"]},
     special:{name:"Zephyr Step",charge:8,upgrades:["18 dmg","20 dmg","22 dmg","25 dmg","25 dmg. Gain Speed Up"]},
     unique:{name:"Slipstream",upgrades:["Attacks Pierce enemies and deal 5% more damage","Attacks Pierce enemies and deal 10% more damage","Attacks Pierce enemies and deal 15% more damage","Attacks Pierce enemies and deal 20% more damage","Attacks Pierce enemies and deal 20% more damage. Attacks have +1 Range"]}
  ...
  {id:"infernoking",name:"Infernoking",emoji:"🦁",type:"Fire",rarity:"common",description:"A blazing lion whose roar sets the sky ablaze. Even its shadow burns.",
   stats:{hp:97,atk:84,def:61,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Flame Claw",upgrades:["18 dmg","24 dmg","31 dmg","40 dmg","Leaves a burning mark; next hit deals +20% dmg"]},
     special:{name:"Inferno Surge",charge:18,upgrades:["ATK +25% for 4s","ATK +35% for 4s","ATK +45% for 5s","ATK +55% for 5s","Also burns nearby enemies for 8 dmg/s"]},
  ...
  {id:"ashmonarch",name:"Ashmonarch",emoji:"👑",type:"Fire",rarity:"common",description:"The apex of the Emberpup line. Its crown of ash is said to contain the last embers of a dying star.",
   stats:{hp:128,atk:112,def:83,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Flame Claw",upgrades:["18 dmg","24 dmg","31 dmg","40 dmg","Leaves a burning mark; next hit deals +20% dmg"]},
     special:{name:"Inferno Surge",charge:18,upgrades:["ATK +25% for 4s","ATK +35% for 4s","ATK +45% for 5s","ATK +55% for 5s","Also burns nearby enemies for 8 dmg/s"]},
  ...
  {id:"verdantlord",name:"Verdaceratops",emoji:"🦏",type:"Nature",rarity:"common",description:"A walking hillside with three ancient horns. It charges rarely, and only once per obstacle.",
   stats:{hp:103,atk:88,def:63,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Horn Ram",upgrades:["20 dmg","26 dmg","33 dmg","42 dmg","Knocks back 2 tiles"]},
     special:{name:"Seismic Trample",charge:12,upgrades:["Charge; 70 dmg to everything in the path; knockback","86 dmg","106 dmg","130 dmg","Stuns everything hit 0.5s"]},
     unique:{name:"Ironwood Frill",upgrades:["Passive: reduce dmg taken 8; attackers take 22 thorn dmg","Reduce 12; thorns 30","Reduce 16; thorns 40","Reduce 22; thorns 52","Reduce 28; thorns 66; immune to knockback"]}
   },role:"Attacker",attackType:"Melee",evolutionOf:"canoparch",shardsToAscend:12,ascensionsToEvolve:45,evolutionId:"ancientgrove"},
  {id:"ancientgrove",name:"Gaiatops",emoji:"🏔️",type:"Nature",rarity:"common",description:"The old forest walks on four legs. Its charge has only ever been described in the past tense.",
   stats:{hp:130,atk:114,def:86,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Gaia Ram",upgrades:["28 dmg","36 dmg","45 dmg","56 dmg","Knocks back 2 tiles and Slows 20%"]},
     special:{name:"Continental Trample",charge:12,upgrades:["Charge; 100 dmg to everything in the path; knockback+Root 1s","122 dmg","148 dmg","180 dmg","Stuns 1s; leaves thorny ground for 4s (15 dmg/s)"]},
     unique:{name:"Worldwood Frill",upgrades:["Passive: reduce dmg taken 12; attackers take 35 thorn dmg","Reduce 16; thorns 46","Reduce 22; thorns 58","Reduce 28; thorns 74","Reduce 36; thorns 92; immune to knockback+stun; allies behind take -15% dmg"]}
  ...
  {id:"granitarch",name:"Granitoad",emoji:"🗿",type:"Earth",rarity:"common",description:"A granite-plated toad stacked with boulders. Its croak registers on seismographs two towns over.",
   stats:{hp:158,atk:78,def:115,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Pebble Spit",upgrades:["9 dmg","10 dmg","11 dmg","12 dmg","13 dmg"]},
     special:{name:"Boulder Hunker",charge:18,upgrades:["Taunt all nearby enemies and gain a Shield equal to 3% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 6% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 9% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 12% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 15% of this creature's Defense"]},
     unique:{name:"Stone Skin",upgrades:["Debuffs expire 10% faster","Debuffs expire 20% faster","Debuffs expire 30% faster","Debuffs expire 40% faster","Debuffs expire 50% faster"]}
  ...
  {id:"mountainking",name:"Toadalith",emoji:"🏔️",type:"Earth",rarity:"common",description:"A toad the size of a hill beneath a peak of stacked boulders. Maps list it as terrain; it prefers 'ambush.'",
   stats:{hp:209,atk:103,def:153,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Pebble Spit",upgrades:["9 dmg","10 dmg","11 dmg","12 dmg","13 dmg"]},
     special:{name:"Boulder Hunker",charge:18,upgrades:["Taunt all nearby enemies and gain a Shield equal to 3% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 6% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 9% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 12% of this creature's Defense","Taunt all nearby enemies and gain a Shield equal to 15% of this creature's Defense"]},
     unique:{name:"Stone Skin",upgrades:["Debuffs expire 10% faster","Debuffs expire 20% faster","Debuffs expire 30% faster","Debuffs expire 40% faster","Debuffs expire 50% faster"]}
  ...
  {id:"tempesthawk",name:"Tempesthawk",emoji:"🦅",type:"Wind",rarity:"common",description:"A Galestride that grew wings of compressed air. Its wingbeats create gales felt miles away.",
   stats:{hp:89,atk:77,def:55,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Gust Swipe",upgrades:["10 dmg","11 dmg","12 dmg","13 dmg","13 dmg and inflict Defense Down"]},
     special:{name:"Zephyr Step",charge:8,upgrades:["18 dmg","20 dmg","22 dmg","25 dmg","25 dmg. Gain Speed Up"]},
     unique:{name:"Slipstream",upgrades:["Attacks Pierce enemies and deal 5% more damage","Attacks Pierce enemies and deal 10% more damage","Attacks Pierce enemies and deal 15% more damage","Attacks Pierce enemies and deal 20% more damage","Attacks Pierce enemies and deal 20% more damage. Attacks have +1 Range"]}
  ...
  {id:"stormlord",name:"Stormlord",emoji:"🌪️",type:"Wind",rarity:"common",description:"The apex of wind. Entire storm systems orbit it like satellites.",
   stats:{hp:116,atk:99,def:72,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Gust Swipe",upgrades:["10 dmg","11 dmg","12 dmg","13 dmg","13 dmg and inflict Defense Down"]},
     special:{name:"Zephyr Step",charge:8,upgrades:["18 dmg","20 dmg","22 dmg","25 dmg","25 dmg. Gain Speed Up"]},
     unique:{name:"Slipstream",upgrades:["Attacks Pierce enemies and deal 5% more damage","Attacks Pierce enemies and deal 10% more damage","Attacks Pierce enemies and deal 15% more damage","Attacks Pierce enemies and deal 20% more damage","Attacks Pierce enemies and deal 20% more damage. Attacks have +1 Range"]}
  ...
  {id:"ashpup",name:"Vixling",emoji:"🦊",type:"Nature",rarity:"common",description:"A woodland red fox kit with leaves tangled in its russet fur. It knows every trail in the forest, including several that don't exist.",
   stats:{hp:41,atk:41,def:22,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"cinderfox",name:"Bramblefox",emoji:"🦊",type:"Nature",rarity:"common",description:"Vixling grown into a cunning hunter. Its tail flicks barbed brambles at anything that follows too closely.",
   stats:{hp:65,atk:67,def:38,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Bramble Shot",upgrades:["10 dmg","13 dmg","17 dmg","22 dmg","Poisons target for 4 dmg/s for 2s"]},
  ...
  {id:"emberlord",name:"Verdanvox",emoji:"🌲",type:"Nature",rarity:"common",description:"A fox of the old forest wearing a mane of autumn leaves. Sylvavix's final and most cunning form.",
   stats:{hp:119,atk:127,def:78,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Bramble Shot",upgrades:["10 dmg","13 dmg","17 dmg","22 dmg","Poisons for 4 dmg/s for 2s"]},
  ...
  {id:"droplette",name:"Droplette",emoji:"💧",type:"Water",rarity:"common",description:"A tiny water sprite no bigger than a raindrop. Its healing tears can soothe any wound.",
   stats:{hp:46,atk:30,def:29,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"bubblin",name:"Bubblin",emoji:"🫧",type:"Water",rarity:"common",description:"A Droplette that has grown a protective bubble shell. It heals by popping mini bubbles.",
   stats:{hp:75,atk:48,def:46,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Water Jet",upgrades:["8 dmg","11 dmg","14 dmg","18 dmg","Reduces target ATK by 8% for 2s"]},
  ...
  {id:"wavecrest",name:"Wavecrest",emoji:"🌊",type:"Water",rarity:"common",description:"Bubblin evolved into a creature that rides its own waves. Heals by surf.",
   stats:{hp:107,atk:69,def:66,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Water Jet",upgrades:["8 dmg","11 dmg","14 dmg","18 dmg","Reduces target ATK by 8% for 2s"]},
  ...
  {id:"tidecrown",name:"Tidecrown",emoji:"🐬",type:"Water",rarity:"common",description:"Wavecrest's final form. The ocean answers its call. Healers across the land seek its blessing.",
   stats:{hp:141,atk:92,def:88,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Water Jet",upgrades:["8 dmg","11 dmg","14 dmg","18 dmg","Reduces target ATK by 8% for 2s"]},
  ...
  {id:"frostpup",name:"Tundracub",emoji:"🐻",type:"Water",rarity:"common",description:"A round, fluffy bear cub with patches of ice growing through its fur. Very huggable, slightly dangerous.",
   stats:{hp:59,atk:29,def:44,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Ice Scratch",upgrades:["10 dmg + 10% slow","13 dmg + 12% slow","17 dmg + 15% slow","22 dmg + 18% slow","Slow lasts 3s"]},
     special:{name:"Frost Coat",charge:14,upgrades:["DEF +20 for 5s","DEF +30","DEF +40","DEF +52","Also freezes next attacker for 0.5s"]},
  ...
  {id:"snowmane",name:"Frostpaw",emoji:"🦌",type:"Water",rarity:"common",description:"An elegant ice deer with antlers that permanently frost the air around it.",
   stats:{hp:95,atk:48,def:72,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Ice Scratch",upgrades:["10 dmg + 10% slow","13 dmg + 12% slow","17 dmg + 15% slow","22 dmg + 18% slow","Slow lasts 3s"]},
     special:{name:"Ice Barrier",charge:12,upgrades:["Shield self 45 HP","Shield 62 HP","Shield 80 HP","Shield 100 HP","Shielded allies are immune to slows"]},
  ...
  {id:"blizzardback",name:"Blizzardback",emoji:"🦣",type:"Water",rarity:"common",description:"A great ice mammoth whose back is covered in a permanent blizzard.",
   stats:{hp:135,atk:67,def:101,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Ice Scratch",upgrades:["10 dmg + 10% slow","13 dmg + 12% slow","17 dmg + 15% slow","22 dmg + 18% slow","Slow lasts 3s"]},
     special:{name:"Blizzard Wall",charge:20,upgrades:["Summon ice wall; enemies hit take 50 dmg","60 dmg","75 dmg","92 dmg","Wall lasts 4s and slows all who touch it 35%"]},
  ...
  {id:"glaciertusk",name:"Glaciarch",emoji:"🐘",type:"Water",rarity:"common",description:"An ancient ice mammoth the size of a small glacier. Its tusks can impale mountains.",
   stats:{hp:177,atk:88,def:133,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Ice Scratch",upgrades:["10 dmg + 10% slow","13 dmg + 12% slow","17 dmg + 15% slow","22 dmg + 18% slow","Slow lasts 3s"]},
     special:{name:"Blizzard Wall",charge:20,upgrades:["Summon ice wall; enemies hit take 50 dmg","60 dmg","75 dmg","92 dmg","Wall lasts 4s; slows all who touch it 35%"]},
  ...
  {id:"sproutlet",name:"Puddlet",emoji:"🐣",type:"Water",rarity:"epic",description:"A fluffy heron hatchling with more legs than balance. It practices spear-fishing in puddles and mostly stabs its own reflection.",
   stats:{hp:53,atk:57,def:34,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"fernback",name:"Wadewing",emoji:"🐦",type:"Water",rarity:"epic",description:"Puddlet grown into its stilts. It stands motionless in the shallows until something forgets it's there.",
   stats:{hp:85,atk:91,def:54,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"rootkeeper",name:"Heronarch",emoji:"🦢",type:"Water",rarity:"epic",description:"The river's crowned sentinel. Every strike is a single perfect line. Fish reportedly organize petitions about it.",
   stats:{hp:132,atk:140,def:88,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"mudpaw",name:"Mudboar",emoji:"🐗",type:"Earth",rarity:"common",description:"A stocky mud boar with rock-hard skin. It rolls into foes like a living boulder.",
   stats:{hp:60,atk:30,def:44,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"clayback",name:"Clayback",emoji:"🦏",type:"Earth",rarity:"common",description:"Mudboar hardened over time. Its hide deflects even bladed weapons.",
   stats:{hp:98,atk:48,def:71,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Mud Tusk",upgrades:["10 dmg","13 dmg","16 dmg","20 dmg","Slows target 15% for 2s"]},
  ...
  {id:"stonecrest",name:"Stonehorn",emoji:"🐊",type:"Earth",rarity:"common",description:"A colossal stone crocodile. Its scales have the hardness of gemstone.",
   stats:{hp:139,atk:69,def:102,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"quarryking",name:"Quarryhorn",emoji:"🦛",type:"Earth",rarity:"common",description:"The immovable final form. A walking quarry whose step reshapes the land.",
   stats:{hp:186,atk:92,def:137,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"puffwing",name:"Puffwing",emoji:"🐦",type:"Wind",rarity:"common",description:"A tiny puffin with wings that generate constant gusts. It hovers even when asleep.",
   stats:{hp:36,atk:37,def:20,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"draftfin",name:"Pufftide",emoji:"🦅",type:"Wind",rarity:"common",description:"Puffwing matured into a sharp-winged hawk that dives at hurricane speeds.",
   stats:{hp:58,atk:61,def:34,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"cyclotail",name:"Stormfin",emoji:"🦜",type:"Wind",rarity:"common",description:"Draftfin's feathers have become blades of compressed air. Its tail generates cyclones.",
   stats:{hp:80,atk:84,def:48,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"stormbeak",name:"Stormbeak",emoji:"🦉",type:"Wind",rarity:"common",description:"The final aerial predator. Stormbeak's wings span skies and its beak can shatter stone.",
   stats:{hp:107,atk:111,def:63,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"sparkpup",name:"Sparkit",emoji:"🐭",type:"Electric",rarity:"common",description:"A tiny mouse with oversized ears that act as lightning rods. Startles easily and discharges.",
   stats:{hp:42,atk:44,def:25,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Static Bite",upgrades:["10 dmg; 15% chance to stun 0.5s","13 dmg; 18%","17 dmg; 22%","22 dmg; 26%","30% chance; stun 0.75s"]},
     special:{name:"Charge Up",charge:22,upgrades:["Next attack +25% dmg","Next +35%","Next +46%","Next +58%","Next +72%; also gains +15 SPD for 2s"]},
   ...
   },role:"Attacker",attackType:"Ranged",shardsToAscend:5,ascensionsToEvolve:15,evolutionId:"voltkit"},
  {id:"voltkit",name:"Voltcat",emoji:"🐱",type:"Electric",rarity:"common",description:"Zaprat evolved into a cracking electric cat. Its purr sounds like a tesla coil.",
   stats:{hp:68,atk:72,def:41,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Static Bite",upgrades:["10 dmg; stun chance 15%","13 dmg; 18%","17 dmg; 22%","22 dmg; 26%","30%; stun 0.75s"]},
     special:{name:"Volt Pounce",charge:10,upgrades:["Pounce; 48 dmg + stun 0.5s","62 dmg","78 dmg","96 dmg","Also leaves electric field at landing for 2s"]},
   ...
   },role:"Attacker",attackType:"Ranged",evolutionOf:"sparkpup",shardsToAscend:8,ascensionsToEvolve:30,evolutionId:"thunderpaw"},
  {id:"thunderpaw",name:"Voltiger",emoji:"🐯",type:"Electric",rarity:"common",description:"A thundering tiger whose stripes are live voltage. Its roar triggers lightning.",
   stats:{hp:94,atk:99,def:57,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Thunder Claw",upgrades:["16 dmg; 20% stun chance 0.5s","21 dmg","27 dmg","35 dmg","25% stun 1s; arcs to nearby foe 50%"]},
     special:{name:"Volt Rush",charge:22,upgrades:["Dash; 62 dmg; leaves electric trail","78 dmg","96 dmg","118 dmg","Trail lasts 3s; enemies in trail stunned 0.5s/s"]},
   ...
   },role:"Attacker",attackType:"Ranged",evolutionOf:"voltkit",shardsToAscend:12,ascensionsToEvolve:45,evolutionId:"boltlion"},
  {id:"boltlion",name:"Boltiger",emoji:"🦁",type:"Electric",rarity:"common",description:"Thundertiger's royal final form. A lion made of living lightning. Every step is a crack of thunder.",
   stats:{hp:124,atk:132,def:77,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Thunder Claw",upgrades:["16 dmg; 20% stun chance 0.5s","21 dmg","27 dmg","35 dmg","25% stun 1s; arcs 50%"]},
     special:{name:"Volt Rush",charge:22,upgrades:["Dash; 62 dmg; electric trail","78 dmg","96 dmg","118 dmg","Trail lasts 3s; enemies stunned 0.5s/s"]},
  ...
  {id:"buzzwig",name:"Buzzwig",emoji:"🐝",type:"Electric",rarity:"common",description:"A fuzzy electric bee that builds nests out of crackling amber. Its sting carries a jolt.",
   stats:{hp:41,atk:41,def:21,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Shock Sting",upgrades:["11 dmg; 20% poison (4 dmg/s 2s)","14 dmg","18 dmg","24 dmg","Poison + 15% slow 2s"]},
     special:{name:"Amber Trap",charge:12,upgrades:["Trap; root 1s + 25 dmg if triggered","Root 1.5s + 32 dmg","Root 2s + 40 dmg","Root 2s + 50 dmg","3 traps simultaneously; each root 2s"]},
   ...
   },role:"Attacker",attackType:"Ranged",shardsToAscend:5,ascensionsToEvolve:15,evolutionId:"zaptail"},
  {id:"zaptail",name:"Zaptail",emoji:"🦟",type:"Electric",rarity:"common",description:"Buzzwig evolved into a lightning-fast electric dragonfly. It strikes before you see it coming.",
   stats:{hp:65,atk:67,def:35,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Shock Sting",upgrades:["11 dmg; 20% shock","14 dmg","18 dmg","24 dmg","Shock + slow 15% 2s"]},
     special:{name:"Zap Dash",charge:10,upgrades:["Dash through enemies; 42 dmg each","54 dmg","68 dmg","84 dmg","Leave electric trail; enemies in trail take 15 dmg/s for 2s"]},
   ...
   },role:"Attacker",attackType:"Ranged",evolutionOf:"buzzwig",shardsToAscend:8,ascensionsToEvolve:30,evolutionId:"shockfang"},
  {id:"shockfang",name:"Shockfang",emoji:"🦎",type:"Electric",rarity:"common",description:"A jagged electric lizard whose fangs deliver voltage directly into the nervous system.",
   stats:{hp:90,atk:92,def:50,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Shock Fang",upgrades:["18 dmg; paralysis 20% chance (stop 0.5s)","23 dmg; 24%","30 dmg; 28%","38 dmg; 32%","35%; paralysis 1s"]},
     special:{name:"Electro Burst",charge:16,upgrades:["55 dmg in burst; stun 0.5s","70 dmg","88 dmg","108 dmg","Stun 1s; stun releases 30 dmg shockwave"]},
   ...
   },role:"Attacker",attackType:"Ranged",evolutionOf:"zaptail",shardsToAscend:12,ascensionsToEvolve:45,evolutionId:"stormhorn"},
  {id:"stormhorn",name:"Stormhorn",emoji:"🦬",type:"Electric",rarity:"common",description:"Shockfang's apex form. A massive electric bison whose horns channel lightning storms.",
   stats:{hp:120,atk:123,def:67,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Shock Fang",upgrades:["18 dmg; paralysis 20%","23 dmg","30 dmg","38 dmg","35%; paralysis 1s"]},
     special:{name:"Electro Burst",charge:16,upgrades:["55 dmg; stun 0.5s","70 dmg","88 dmg","108 dmg","Stun 1s; shockwave 30 dmg"]},
  ...
  {id:"glowpup",name:"Jadebun",emoji:"🐰",type:"Light",rarity:"common",description:"A rabbit whose fur carries the cool green sheen of polished jade. It gathers moonlit herbs in its cheeks and refuses to explain why.",
   stats:{hp:43,atk:28,def:26,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"radiantkit",name:"Pestlehare",emoji:"🐇",type:"Light",rarity:"common",description:"Jadebun has taken up a mortar and pestle twice its own height. Neighbors report that the pounding begins promptly at moonrise and does not stop.",
   stats:{hp:70,atk:46,def:44,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Herb Poultice",upgrades:["Heal 10 HP","Heal 12 HP","Heal 14 HP","Heal 17 HP","Heal 20 HP"]},
     special:{name:"Silver Draught",charge:18,upgrades:["Heal 24 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 29 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 35 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 42 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 42 HP and shield them. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal"]},
     unique:{name:"Pestle Tempo",upgrades:["When an ally within range is below 50% Health, gain 2% Haste and Speed","When an ally within range is below 50% Health, gain 4% Haste and Speed","When an ally within range is below 50% Health, gain 6% Haste and Speed","When an ally within range is below 50% Health, gain 8% Haste and Speed","When an ally within range is below 50% Health, gain 10% Haste and Speed"]}
  ...
  {id:"dawnbeast",name:"Elixhare",emoji:"🌙",type:"Light",rarity:"common",description:"Its mortar now yields a silver draught that knits wounds closed in seconds. Three separate alchemists' guilds have offered to buy the recipe. It has declined all three.",
   stats:{hp:100,atk:65,def:62,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Herb Poultice",upgrades:["Heal 10 HP","Heal 12 HP","Heal 14 HP","Heal 17 HP","Heal 20 HP"]},
     special:{name:"Silver Draught",charge:18,upgrades:["Heal 24 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 29 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 35 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 42 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 42 HP and shield them. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal"]},
     unique:{name:"Pestle Tempo",upgrades:["When an ally within range is below 50% Health, gain 2% Haste and Speed","When an ally within range is below 50% Health, gain 4% Haste and Speed","When an ally within range is below 50% Health, gain 6% Haste and Speed","When an ally within range is below 50% Health, gain 8% Haste and Speed","When an ally within range is below 50% Health, gain 10% Haste and Speed"]}
  ...
  {id:"solarcrown",name:"Lunarch",emoji:"🌕",type:"Light",rarity:"common",description:"The Jade Rabbit of legend, ascended to the moon to pound the elixir of immortality at Chang'e's side. It still comes back down for a gentle nuzzle.",
   stats:{hp:133,atk:87,def:82,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Herb Poultice",upgrades:["Heal 10 HP","Heal 12 HP","Heal 14 HP","Heal 17 HP","Heal 20 HP"]},
     special:{name:"Silver Draught",charge:18,upgrades:["Heal 24 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 29 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 35 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 42 HP. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal","Heal 42 HP and shield them. If they're above 50% Health, they gain Attack Up. If they're below 50% Health, they briefly gain Immortal"]},
     unique:{name:"Pestle Tempo",upgrades:["When an ally within range is below 50% Health, gain 2% Haste and Speed","When an ally within range is below 50% Health, gain 4% Haste and Speed","When an ally within range is below 50% Health, gain 6% Haste and Speed","When an ally within range is below 50% Health, gain 8% Haste and Speed","When an ally within range is below 50% Health, gain 10% Haste and Speed"]}
  ...
  {id:"shimmerfly",name:"Shimmerfly",emoji:"🦋",type:"Light",rarity:"common",description:"A butterfly made of prismatic light. Its wing dust blinds enemies and heals allies.",
   stats:{hp:36,atk:23,def:22,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Prism Dust",upgrades:["7 dmg; 20% blind 1s","9 dmg","12 dmg","15 dmg","25% blind 1.5s"]},
     special:{name:"Wing Heal",charge:18,upgrades:["Heal ally 20 HP","Heal 28 HP","Heal 37 HP","Heal 48 HP","Heal + grant 5% dodge for 3s"]},
   ...
   },role:"Support",attackType:"Ranged",shardsToAscend:5,ascensionsToEvolve:15,evolutionId:"lumiwing"},
  {id:"lumiwing",name:"Lumiwing",emoji:"🌟",type:"Light",rarity:"common",description:"Shimmerfly with wings that now emit constant healing pulses.",
   stats:{hp:59,atk:38,def:37,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Prism Dust",upgrades:["7 dmg; blind 20%","9 dmg","12 dmg","15 dmg","25%; blind 1.5s"]},
     special:{name:"Luminous Barrier",charge:14,upgrades:["Shield ally 38 HP; 8% dodge","Shield 52; 12%","Shield 68; 16%","Shield 86; 20%","Shield all allies 28 HP; 12% dodge"]},
   ...
   },role:"Support",attackType:"Ranged",evolutionOf:"shimmerfly",shardsToAscend:8,ascensionsToEvolve:30,evolutionId:"brightclaw"},
  {id:"brightclaw",name:"Brightmoth",emoji:"🕊️",type:"Light",rarity:"common",description:"Lumiwing transformed into a dove of blazing light. Its talons carry purifying fire.",
   stats:{hp:87,atk:57,def:54,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Light Talon",upgrades:["12 dmg; cleanse 1 ally debuff on hit","16 dmg","21 dmg","27 dmg","Cleanse all debuffs from 1 ally"]},
     special:{name:"Bright Heal",charge:20,upgrades:["Heal all allies 32 HP; remove 1 debuff each","Heal 44","Heal 58","Heal 74","Heal 92; remove all debuffs; grant immunity to 1 debuff for 4s"]},
   ...
   },role:"Support",attackType:"Ranged",evolutionOf:"lumiwing",shardsToAscend:12,ascensionsToEvolve:45,evolutionId:"celestipaw"},
  {id:"celestipaw",name:"Starmoth",emoji:"✨",type:"Light",rarity:"common",description:"Brightclaw ascended to pure starlight. A luminous lynx whose form transcends the physical, embodying light itself.",
   stats:{hp:118,atk:77,def:73,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Light Talon",upgrades:["12 dmg; cleanse ally","16 dmg","21 dmg","27 dmg","Cleanse all"]},
     special:{name:"Celestial Heal",charge:8,upgrades:["Heal all allies 50 HP; remove all debuffs; grant +15% DEF 4s","Heal 66","Heal 84","Heal 105","Heal 128 HP; +20% all stats 5s; grant regen 12 HP/s 4s"]},
  ...
  {id:"shadowpup",name:"Duskling",emoji:"🐈‍⬛",type:"Dark",rarity:"common",description:"A small black cat that flickers in and out of shadow. Enjoys knocking things off shelves.",
   stats:{hp:45,atk:45,def:22,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"gloomkit",name:"Nightbat",emoji:"🦇",type:"Dark",rarity:"common",description:"Duskling evolved into a stealthy shadow bat. It strikes from the darkness and vanishes.",
   stats:{hp:71,atk:72,def:37,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"nightstalker",name:"Nightstalker",emoji:"🐺",type:"Dark",rarity:"common",description:"Nightbat grown into a shadowy wolf that hunts by instinct alone. It never misses.",
   stats:{hp:99,atk:102,def:54,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"voidfang",name:"Voidfang",emoji:"🐉",type:"Dark",rarity:"common",description:"Nightstalker's final dark dragon form. It does not walk. It unexists from one place and reappears at another.",
   stats:{hp:133,atk:135,def:72,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"murkwing",name:"Murkwing",emoji:"🕷️",type:"Dark",rarity:"common",description:"A shadowy bat that drains energy from those around it. Even torches dim in its presence.",
   stats:{hp:38,atk:36,def:26,spd:1,abilitySpeed:1},
   abilities:{
     ...
     special:{name:"Shadow Shriek",charge:12,upgrades:["Shriek; silence all nearby 1s + 25 dmg","Silence 1.5s + 32 dmg","Silence 2s + 40 dmg","Silence 2s + 50 dmg","Silence 2.5s + 62 dmg; also reduce Ability Speed 20%"]},
     unique:{name:"Life Leech",upgrades:["Passive: 15% of dmg dealt heals Murkwing","18%","22%","26%","30%; excess healing shields up to 30 HP"]}
   },role:"Attacker",attackType:"Melee",shardsToAscend:5,ascensionsToEvolve:15,evolutionId:"darkpaw"},
  {id:"darkpaw",name:"Corvoid",emoji:"🐦‍⬛",type:"Dark",rarity:"common",description:"Murkwing evolved into a sleek black raven. Its gaze saps the will to fight.",
   stats:{hp:62,atk:58,def:42,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Drain Bite",upgrades:["9 dmg; heal 4","12 dmg; heal 5","15 dmg; heal 7","20 dmg; heal 9","Heal 12; reduce ATK 8% 2s"]},
     special:{name:"Curse",charge:12,upgrades:["Curse target: -15% ATK and DEF for 4s","-20% for 4s","-25% for 5s","-32% for 5s","-40% for 6s; curse spreads to 1 nearby foe"]},
   ...
   },role:"Attacker",attackType:"Melee",evolutionOf:"murkwing",shardsToAscend:8,ascensionsToEvolve:30,evolutionId:"shadowcrest"},
  {id:"shadowcrest",name:"Shadowcrest",emoji:"🦅",type:"Dark",rarity:"common",description:"Darkraven grown into a dark eagle whose feathers absorb light. Looking at it causes unease.",
   stats:{hp:86,atk:80,def:62,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Void Talon",upgrades:["14 dmg; heal 6; reduce ATK 10% 2s","18 dmg","23 dmg","30 dmg","ATK -14%; heal 10 HP"]},
     special:{name:"Dark Aura",charge:18,upgrades:["All enemies -15% ATK -10% DEF for 5s","-20% ATK -14% DEF","-26% ATK -18% DEF","-32% ATK -22% DEF","-40% ATK -28% DEF; also -20% SPD"]},
   ...
   },role:"Attacker",attackType:"Melee",evolutionOf:"darkpaw",shardsToAscend:12,ascensionsToEvolve:45,evolutionId:"abysslord"},
  {id:"abysslord",name:"Abysslord",emoji:"🌑",type:"Dark",rarity:"common",description:"The void given form. Shadowcrest's final evolution exists on the border between world and nothingness.",
   stats:{hp:114,atk:108,def:84,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"frostfang",name:"Frostfang",emoji:"🐺",type:"Water",rarity:"epic",description:"A cold-blooded predator whose howl drops the temperature in a wide area.",
   stats:{hp:66,atk:59,def:45,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"glacierwulf",name:"Glacierwulf",emoji:"❄️",type:"Water",rarity:"epic",description:"Frostfang reborn in permafrost. Its breath alone freezes the air.",
   stats:{hp:106,atk:94,def:72,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Ice Fang",upgrades:["12 dmg + 15% slow","16 dmg + 20% slow","21 dmg + 25% slow","27 dmg + 30% slow","Freeze target solid for 1.5s on 5th hit"]},
     special:{name:"Blizzard Howl",charge:8,upgrades:["Chills enemies in radius 3","Chills radius 4","Chills radius 5","Chills radius 6","Fully freezes all chilled enemies in range"]},
  ...
  {id:"voltail",name:"Voltail",emoji:"⚡",type:"Electric",rarity:"common",description:"Its tail acts as a lightning rod, storing energy for devastating strikes.",
   stats:{hp:63,atk:64,def:35,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"stormclaw",name:"Stormclaw",emoji:"🌩️",type:"Electric",rarity:"common",description:"A Voltail so overcharged it permanently crackles with uncontained lightning.",
   stats:{hp:99,atk:103,def:56,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Static Zap",upgrades:["14 dmg","19 dmg","25 dmg","32 dmg","Arcs to 1 nearby foe for 50% damage"]},
     special:{name:"Charge Up",charge:22,upgrades:["Next ability +20% dmg","Next +30%","Next +40%","Next +55%","Also grants a charge shield absorbing 20 dmg"]},
  ...
  {id:"seadrake",name:"Seadrake",emoji:"🐍",type:"Water",rarity:"common",description:"A sleek oceanic serpent that moves like a current and strikes like a wave.",
   stats:{hp:69,atk:59,def:41,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"deepdrake",name:"Bathydrake",emoji:"🐍",type:"Water",rarity:"common",description:"Seadrake fully grown. It coils around ships and drags them to the seafloor.",
   stats:{hp:105,atk:90,def:64,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"abyssdrake",name:"Abyssaur",emoji:"🐉",type:"Water",rarity:"common",description:"An ancient leviathan. Every ocean myth traces back to this creature.",
   stats:{hp:144,atk:123,def:87,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Water Fang",upgrades:["12 dmg+slow","16 dmg","20 dmg","26 dmg","Poison 2s"]},
  ...
  {id:"leviadon",name:"Leviadon",emoji:"🐉",type:"Water",rarity:"common",description:"Abyssaur grown past mythology. Cartographers no longer draw sea monsters on maps; they draw where Leviadon was last sighted.",
   stats:{hp:187,atk:160,def:113,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"lavagator",name:"Lavagator",emoji:"🐊",type:"Fire",rarity:"epic",description:"A lava-soaked crocodile that lurks in molten rivers. Approach only if you are also on fire.",
   stats:{hp:79,atk:55,def:58,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"magmadrake",name:"Magmadrake",emoji:"🐊",type:"Fire",rarity:"epic",description:"Lavagator evolved into a draconic fire lizard. Geysers erupt in its footprints.",
   stats:{hp:119,atk:82,def:87,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"cinderdrake",name:"Pyrotegu",emoji:"🐉",type:"Fire",rarity:"epic",description:"Magmadrake's final draconic form. A true fire dragon whose breath melts mountains.",
   stats:{hp:163,atk:111,def:118,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Lava Snap",upgrades:["14 dmg+burn","18 dmg","23 dmg","30 dmg","Burn 5 dmg/s 3s"]},
  ...
  {id:"blazemoth",name:"Blazemoth",emoji:"🦋",type:"Fire",rarity:"common",description:"A moth irresistibly drawn to flame, now made entirely of it. Navigation is not its strong suit.",
   stats:{hp:58,atk:59,def:32,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"scorchwing",name:"Scorchwing",emoji:"🦋",type:"Fire",rarity:"common",description:"Blazemoth whose wings have become sheets of living flame. Entire forests ignite in its wake.",
   stats:{hp:87,atk:90,def:50,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"infernosprite",name:"Infernosprite",emoji:"🦋",type:"Fire",rarity:"common",description:"Scorchwing transcended into pure flame. It no longer has a physical form — only fire.",
   stats:{hp:118,atk:122,def:68,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"novasprite",name:"Novasprite",emoji:"☄️",type:"Fire",rarity:"common",description:"Infernosprite condensed into a single point of stellar fire. Moth enthusiasts insist it still counts.",
   stats:{hp:153,atk:159,def:88,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"poisonwyrm",name:"Regicobra",emoji:"🐉",type:"Nature",rarity:"common",description:"A legendary toxic wyrm. Its scales shed clouds of spores that poison entire regions.",
   ...
   abilities:{
     basic:{name:"Venom Bite",upgrades:["11 dmg+poison","14 dmg","18 dmg","24 dmg","Poison+DEF-10%"]},
     special:{name:"Spore Eruption",charge:22,upgrades:["Huge cloud; poison all 8s","Poison stronger","Even stronger","Max poison","Spores also paralyze 1s; spread to 2 nearby foes"]},
   ...
   },role:"Attacker",attackType:"Melee",evolutionOf:"toxicserpent",shardsToAscend:22,ascensionsToEvolve:45,evolutionId:"ophidrax"},
  {id:"ophidrax",name:"Ophidrax",emoji:"🐉",type:"Nature",rarity:"common",description:"Regicobra with an empire. Its venom no longer poisons individuals so much as regions, which it considers efficient.",
   stats:{hp:156,atk:146,def:114,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Sovereign Bite",upgrades:["14 dmg+poison","18 dmg","23 dmg","30 dmg","Poison+DEF-14%"]},
     special:{name:"Blight Eruption",charge:22,upgrades:["Vast cloud; poison all 10s","Poison stronger","Even stronger","Max poison","Spores paralyze 1.5s; spread to all nearby foes"]},
     unique:{name:"Venom Emperor",upgrades:["Passive: poison stacks cap +4; poison deals +25% dmg","Cap +5; +32%","Cap +6; +40%","Cap +7; +50%","Cap +8; +62%; Ophidrax heals 22 HP per poison stack active on any enemy"]}
   },role:"Attacker",attackType:"Melee",evolutionOf:"poisonwyrm",shardsToAscend:28,ascensionsToEvolve:null},
  // Nature line 2
  ...
  {id:"crystalshell",name:"Crystalshell",emoji:"🦀",type:"Nature",rarity:"epic",description:"Jadekrab's ultimate form. A mobile fortress of living crystal that heals everything around it.",
   ...
   abilities:{
     basic:{name:"Vine Pinch",upgrades:["10 dmg; root 0.5s","13 dmg","17 dmg","22 dmg","Root 1s; heal 10 HP"]},
     special:{name:"Crystal Bloom",charge:10,upgrades:["Heal all allies 60 HP+regen 8 HP/s+cleanse","Heal 78","Heal 98","Heal 122","Revive 1 fallen ally at 25% HP; cleanse all; regen 12 HP/s"]},
  ...
  {id:"thornturtle",name:"Thornturtle",emoji:"🐢",type:"Nature",rarity:"epic",description:"A turtle whose shell has grown a thicket of razor thorns. Even looking at it hurts.",
   stats:{hp:81,atk:41,def:62,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"jadeshell",name:"Jadeshell",emoji:"🐢",type:"Nature",rarity:"epic",description:"Thornturtle grown to the size of a small island. Entire ecosystems have formed on its back.",
   stats:{hp:122,atk:61,def:93,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"ancientshell",name:"Shellith",emoji:"🐢",type:"Nature",rarity:"epic",description:"An ageless colossus. Ancientshell has outlived civilizations. Mountains erode before its shell does.",
   stats:{hp:166,atk:83,def:126,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Thorn Snap",upgrades:["10 dmg+thorn return","13 dmg","16 dmg","21 dmg","Thorn return 15"]},
  ...
  {id:"titanmole",name:"Titanmole",emoji:"🦔",type:"Earth",rarity:"epic",description:"Steelmole's titan form. Its tunnels cause earthquakes. Geologists blame it for every continental shift.",
   ...
   abilities:{
     basic:{name:"Iron Claw",upgrades:["12 dmg; DEF-6%","15 dmg","19 dmg","25 dmg","DEF-10%+slow 15%"]},
     special:{name:"Titan Drill",charge:22,upgrades:["Pierce through all foes in line; 100 dmg+DEF-25%","120 dmg","145 dmg","175 dmg","Pierce+stun 2s+strip all buffs"]},
  ...
  {id:"dustcrawler",name:"Pulvicrawl",emoji:"🦂",type:"Earth",rarity:"epic",description:"A fat desert scorpion that hides under sand and ambushes prey. Masters the art of patience.",
   stats:{hp:71,atk:63,def:48,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"sandcrawler",name:"Arenid",emoji:"🦂",type:"Earth",rarity:"epic",description:"Dustcrawler evolved. It moves through sand as fast as other creatures move through air.",
   stats:{hp:108,atk:95,def:73,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"dunekraken",name:"Dunekraken",emoji:"🦂",type:"Earth",rarity:"epic",description:"A mythical desert colossus. Dunekraken doesn't burrow through sand — it is the sand.",
   stats:{hp:147,atk:130,def:99,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Sand Sting",upgrades:["12 dmg+blind","15 dmg","19 dmg","25 dmg","Blind+slow"]},
     special:{name:"Kraken Burial",charge:14,upgrades:["Bury all nearby 2s+60 dmg each","76 dmg","95 dmg","118 dmg","Bury 3s; strip all buffs; +30% dmg taken while buried"]},
  ...
  {id:"skyeel",name:"Skyeel",emoji:"🐉",type:"Wind",rarity:"common",description:"A long serpentine eel that drifts through the upper atmosphere. Surprisingly fast for something that has no legs.",
   stats:{hp:52,atk:55,def:31,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"galeeel",name:"Vorteel",emoji:"🐉",type:"Wind",rarity:"common",description:"Skyeel that has absorbed a gale. It moves faster than the eye can track.",
   stats:{hp:78,atk:84,def:50,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"stormeel",name:"Stormeel",emoji:"🐉",type:"Wind",rarity:"common",description:"A storm given serpent form. Stormeel's passage reshapes cloud formations permanently.",
   stats:{hp:107,atk:114,def:67,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Gale Fang",upgrades:["12 dmg+push","15 dmg","19 dmg","25 dmg","Push+slow 20%"]},
  ...
  {id:"hurricaneel",name:"Hurricaneel",emoji:"🌀",type:"Wind",rarity:"common",description:"Stormeel promoted to a named weather system. Meteorologists track it; it does not track back.",
   stats:{hp:138,atk:148,def:88,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"squallhawk",name:"Squallhawk",emoji:"🦅",type:"Wind",rarity:"common",description:"A hawk that rides its own personal squall. Technically never touches the ground.",
   stats:{hp:53,atk:55,def:30,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"galebeak",name:"Galebeak",emoji:"🦅",type:"Wind",rarity:"common",description:"Squallhawk grown. Its beak can pierce steel and its talons generate sonic booms.",
   stats:{hp:80,atk:83,def:45,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"strikewing",name:"Strikewing",emoji:"🦅",type:"Wind",rarity:"common",description:"An apex aerial predator. Strikewing hits with the force of a lightning bolt and vanishes before you register the pain.",
   stats:{hp:111,atk:114,def:61,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Thunder Talon",upgrades:["18 dmg+knockback+slow","23 dmg","30 dmg","38 dmg","Knockback+stun 0.5s+slow 30%"]},
     special:{name:"Apex Dive",charge:12,upgrades:["100 dmg+stun 1.5s; shockwave 60 dmg","120 dmg","145 dmg","175 dmg","Shockwave hits all; stun 2s; all hit lose 1 buff"]},
   ...
   },role:"Attacker",attackType:"Ranged",evolutionOf:"galebeak",shardsToAscend:22,ascensionsToEvolve:45,evolutionId:"stormraptor"},
  {id:"stormraptor",name:"Stormraptor",emoji:"🦅",type:"Wind",rarity:"common",description:"Strikewing past its final growth spurt. Its dives register as micro-bursts; its victims register nothing at all.",
   stats:{hp:143,atk:148,def:80,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Tempest Talon",upgrades:["23 dmg+knockback+slow","29 dmg","37 dmg","47 dmg","Knockback+stun 1s+slow 35%"]},
     special:{name:"Terminal Dive",charge:12,upgrades:["125 dmg+stun 1.5s; shockwave 80 dmg","150 dmg","180 dmg","218 dmg","Shockwave hits all; stun 2.5s; all hit lose 2 buffs"]},
     unique:{name:"Stormfront Predator",upgrades:["Passive: +44% crit; crits on slowed foes +50% dmg; wind attacks ignore 26% DEF","Crit +52%; +62% dmg; ignore 32%","Crit +60%; +74% dmg; ignore 40%","Crit +70%; +88% dmg; ignore 50%","Crit +82%; +105% dmg; ignore 62%; Stormraptor cannot be targeted while flying between attacks"]}
   },role:"Attacker",attackType:"Ranged",evolutionOf:"strikewing",shardsToAscend:28,ascensionsToEvolve:null},
  // Wind line 3
  {id:"whirlbug",name:"Whirlbug",emoji:"🪲",type:"Wind",rarity:"common",description:"A large spinning beetle that generates a personal tornado at all times. Very hard to catch.",
   stats:{hp:51,atk:54,def:30,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"cyclonbug",name:"Cyclonbug",emoji:"🪲",type:"Wind",rarity:"common",description:"Whirlbug grown. Its spin generates F3-level winds. Construction workers hate it.",
   stats:{hp:78,atk:81,def:45,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"vortexbug",name:"Vortexbug",emoji:"🪲",type:"Wind",rarity:"common",description:"A living vortex in beetle form. Vortexbug doesn't fight enemies. It just spins until they stop existing.",
   stats:{hp:105,atk:110,def:62,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Vortex Slash",upgrades:["20 dmg all nearby+push+slow","26 dmg","33 dmg","42 dmg","Push+stun 0.5s+slow 35%"]},
     special:{name:"Vortex Core",charge:10,upgrades:["Super spin; 80 dmg all+pull+slow 50% 4s","96 dmg","116 dmg","140 dmg","Pull+silence 2s+strip 2 buffs"]},
   ...
   },role:"Attacker",attackType:"Melee",evolutionOf:"cyclonbug",shardsToAscend:22,ascensionsToEvolve:45,evolutionId:"typhoonid"},
  {id:"typhoonid",name:"Typhoonid",emoji:"🪲",type:"Wind",rarity:"common",description:"Vortexbug at escape velocity. It has technically stopped spinning; the world now spins around it.",
   stats:{hp:137,atk:143,def:81,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Typhoon Slash",upgrades:["25 dmg all nearby+push+slow","32 dmg","41 dmg","52 dmg","Push+stun 1s+slow 40%"]},
     special:{name:"Typhoon Core",charge:10,upgrades:["Super spin; 100 dmg all+pull+slow 55% 4s","120 dmg","145 dmg","175 dmg","Pull+silence 3s+strip all buffs"]},
     unique:{name:"World Spin",upgrades:["Passive: aura -38% ATK+SPD+Ability Speed on foes; +32% dodge; dmg 26/s","Aura -46%; dodge +38%; dmg 33/s","Aura -55%; dodge +45%; dmg 42/s","Aura -65%; dodge +54%; dmg 52/s","Aura -76%; dodge +64%; dmg 65/s; Typhoonid immune to all projectiles; dodges trigger free Typhoon Core once per 4s"]}
   },role:"Attacker",attackType:"Melee",evolutionOf:"vortexbug",shardsToAscend:28,ascensionsToEvolve:null},
  // Electric stage 3
  {id:"arcstorm",name:"Arcstorm",emoji:"🌩️",type:"Electric",rarity:"common",description:"Stormclaw transcended. It no longer moves — it teleports between lightning bolts.",
   stats:{hp:127,atk:132,def:73,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"ionarch",name:"Ionarch",emoji:"⚡",type:"Electric",rarity:"common",description:"Arcstorm crowned. It rules a court of lightning bolts that arrive slightly before it gives the order.",
   stats:{hp:166,atk:172,def:95,spd:1,abilitySpeed:1},
   abilities:{
     ...
     unique:{name:"Storm Singularity",upgrades:["Passive: every hit arcs to 4 foes 70% dmg; electric +28%","Arc 5 foes 80%; +34%","Arc 6 foes 90%; +42%","Arc 8 foes 100%; +50%","Arc all foes 110%; +60%; arcs stun 0.5s; Ionarch immune to paralysis+stun"]}
  ...
  {id:"zapfrog",name:"Zapfrog",emoji:"🐸",type:"Electric",rarity:"common",description:"A neon frog whose skin conducts lethal voltage. Its croak causes nearby electronics to malfunction.",
   stats:{hp:55,atk:58,def:34,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"voltfrog",name:"Voltfrog",emoji:"🐸",type:"Electric",rarity:"common",description:"Zapfrog grown. Its croak is now a thunderclap. Meteorologists have blamed it for freak storms.",
   stats:{hp:84,atk:89,def:54,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"stormtoad",name:"Fulgutoad",emoji:"🐸",type:"Electric",rarity:"common",description:"Voltfrog's ultimate form. A colossal electric toad that literally rains lightning from its body.",
   stats:{hp:113,atk:120,def:71,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Volt Tongue",upgrades:["12 dmg+slow","15 dmg","19 dmg","25 dmg","Shock 2s also"]},
  ...
  {id:"tempestoad",name:"Tempestoad",emoji:"🐸",type:"Electric",rarity:"common",description:"Fulgutoad with its own climate. It croaks once per storm, mostly out of politeness.",
   stats:{hp:147,atk:156,def:92,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"shockbeetle",name:"Shockbeetle",emoji:"🪲",type:"Electric",rarity:"common",description:"A metallic beetle that stores charge in its shell. Touching it is inadvisable.",
   stats:{hp:68,atk:48,def:52,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"voltbeetle",name:"Voltbeetle",emoji:"🪲",type:"Electric",rarity:"common",description:"Shockbeetle evolved. Its shell is now a superconductor. Scientists want to study it. It disagrees.",
   stats:{hp:104,atk:72,def:78,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"arcbeetle",name:"Arcbeetle",emoji:"🪲",type:"Electric",rarity:"common",description:"Voltbeetle's arc-welded final form. It generates its own electromagnetic field that disrupts everything nearby.",
   stats:{hp:142,atk:98,def:106,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Arc Slam",upgrades:["22 dmg+paralyze 28% 1.5s","28 dmg","36 dmg","46 dmg","Paralyze 38% 2s; arc to 1 nearby 60%"]},
     special:{name:"Arc Explosion",charge:22,upgrades:["120 dmg; EM burst disables abilities 2s+stun 1.5s","144 dmg","172 dmg","204 dmg","Disable 3s; stun 2s; chain full power to 2 nearby"]},
   ...
   },role:"Tank",attackType:"Melee",evolutionOf:"voltbeetle",shardsToAscend:22,ascensionsToEvolve:45,evolutionId:"dynamid"},
  {id:"dynamid",name:"Dynamid",emoji:"🔋",type:"Electric",rarity:"common",description:"Arcbeetle rebuilt around its own reactor. Power companies list it as both a competitor and a hazard.",
   stats:{hp:184,atk:128,def:137,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Dynamo Slam",upgrades:["28 dmg+paralyze 32% 1.5s","36 dmg","46 dmg","58 dmg","Paralyze 44% 2s; arc to 2 nearby 70%"]},
     special:{name:"Reactor Burst",charge:22,upgrades:["150 dmg; EM burst disables abilities 2.5s+stun 2s","180 dmg","216 dmg","260 dmg","Disable 3.5s; stun 2.5s; chain full power to 3 nearby"]},
     unique:{name:"Fusion Core",upgrades:["Passive: EM aura; all enemies -32% Ability Speed+paralyze 20% each action","-38%; paralyze 25%","-46%; paralyze 31%","-55%; paralyze 38%","-65%; paralyze 46%; Dynamid revives once; death triggers full EMP stunning all enemies 4s"]}
   },role:"Tank",attackType:"Melee",evolutionOf:"arcbeetle",shardsToAscend:28,ascensionsToEvolve:null},
  // Light line 1
  ...
  {id:"celestbird",name:"Celestbird",emoji:"🦜",type:"Light",rarity:"common",description:"Radiancebird ascended into a being of pure celestial light. Its very existence heals the world around it.",
   ...
   abilities:{
     ...
     special:{name:"Celestial Song",charge:18,upgrades:["Heal all allies 65 HP; regen 12 HP/s; remove all debuffs; grant +18% all stats","Heal 82","Heal 102","Heal 126","Heal 155; regen 18 HP/s; revive 1 fallen ally 30% HP; all stats +25%"]},
   ...
   },role:"Support",attackType:"Ranged",evolutionOf:"radiancebird",shardsToAscend:22,ascensionsToEvolve:45,evolutionId:"empyravis"},
  {id:"empyravis",name:"Empyravis",emoji:"🕊️",type:"Light",rarity:"common",description:"Celestbird beyond the sky it was named for. It sings in wavelengths that mend whatever hears them.",
   stats:{hp:138,atk:101,def:120,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Empyrean Peck",upgrades:["20 dmg; cleanse all allies 1 debuff each","26 dmg","33 dmg","42 dmg","Also grant 2 buffs to random allies"]},
     special:{name:"Empyrean Chorus",charge:18,upgrades:["Heal all allies 82 HP; regen 16 HP/s; remove all debuffs; grant +24% all stats","Heal 102","Heal 128","Heal 158","Heal 195; regen 24 HP/s; revive 1 fallen ally 45% HP; all stats +32%"]},
     unique:{name:"Grace Eternal",upgrades:["Passive: all healing +44%; all allies regen 11 HP/s","+52%; regen 14","+62%; regen 18","+72%; regen 23","+85%; regen 30; Empyravis revives 3 times; each time heals all allies 90 HP and blinds enemies 2.5s"]}
   },role:"Support",attackType:"Ranged",evolutionOf:"celestbird",shardsToAscend:28,ascensionsToEvolve:null},
  // Light line 2
  ...
  {id:"spectrumcrab",name:"Spectrumcrab",emoji:"🦀",type:"Light",rarity:"common",description:"Prismcrab evolved. Its shell now projects full spectrums that disorient entire armies.",
   stats:{hp:105,atk:69,def:66,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"rainbowshell",name:"Rainbowshell",emoji:"🦀",type:"Light",rarity:"common",description:"The final prismatic form. Rainbowshell's shell contains every frequency of light. Nothing can hit what it cannot see.",
   stats:{hp:143,atk:93,def:90,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Spectrum Pinch",upgrades:["13 dmg+blind 22%","16 dmg","21 dmg","27 dmg","30% blind 2s; heal 8 HP"]},
     special:{name:"Rainbow Aegis",charge:14,upgrades:["Shield all allies 78 HP+35% dodge+cleanse 1 debuff","Shield 98+42%","Shield 122+50%","Shield 150+58%","Shield 182+68%; cleanse all; grant immune to blind+slow 6s"]},
   ...
   },role:"Support",attackType:"Ranged",evolutionOf:"spectrumcrab",shardsToAscend:22,ascensionsToEvolve:45,evolutionId:"chromatarch"},
  {id:"chromatarch",name:"Chromatarch",emoji:"🦀",type:"Light",rarity:"common",description:"Rainbowshell claiming every color at once. Looking directly at it is considered a compliment.",
   stats:{hp:186,atk:121,def:117,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Chroma Pinch",upgrades:["16 dmg+blind 26%","20 dmg","26 dmg","33 dmg","36% blind 2.5s; heal 12 HP"]},
     special:{name:"Chromatic Aegis",charge:14,upgrades:["Shield all allies 98 HP+42% dodge+cleanse 1 debuff","Shield 122+50%","Shield 152+58%","Shield 188+66%","Shield 230+76%; cleanse all; grant immunity to blind+slow 7s"]},
     unique:{name:"Total Spectrum",upgrades:["Passive: 38% deflect 82 dmg; blind 2s; allies +24% dodge; deflections heal all 20 HP","44% deflect 102; +28%; heal 26","52% deflect 128; +33%; heal 33","60% deflect 158; +38%; heal 42","70% deflect 195; +45%; heal 55; Chromatarch cannot be blinded; revives once healing all allies 110 HP"]}
   },role:"Support",attackType:"Ranged",evolutionOf:"rainbowshell",shardsToAscend:28,ascensionsToEvolve:null},
  // Light line 3
  {id:"holymoth",name:"Sacramoth",emoji:"🦋",type:"Light",rarity:"common",description:"A moth that orbits holy shrines. Where it lands, wounds close and darkness retreats.",
   stats:{hp:58,atk:39,def:38,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"radiantmoth",name:"Lumimoth",emoji:"🦋",type:"Light",rarity:"common",description:"Holymoth evolved. Its wing scales now emit a radiance that makes allies temporarily invulnerable.",
   stats:{hp:87,atk:57,def:57,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"celestimoth",name:"Celestimoth",emoji:"🦋",type:"Light",rarity:"common",description:"Radiantmoth's celestial final form. The light from its wings can be seen from the other side of the world.",
   stats:{hp:117,atk:78,def:77,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"seraphlume",name:"Seraphlume",emoji:"🦋",type:"Light",rarity:"common",description:"Celestimoth's last metamorphosis. Its wings are no longer lit; they are the source everything else is lit by.",
   stats:{hp:152,atk:101,def:100,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"voidspider",name:"Vacurach",emoji:"🕷️",type:"Dark",rarity:"common",description:"A spider that spins webs out of solidified void. Prey caught in its web simply stops existing.",
   stats:{hp:61,atk:64,def:37,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"shadowspider",name:"Umbrachnid",emoji:"🕷️",type:"Dark",rarity:"common",description:"Voidspider grown to the size of a cart horse. Its webs cover entire dungeon floors.",
   stats:{hp:91,atk:97,def:56,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"abyssspider",name:"Abyrach",emoji:"🕷️",type:"Dark",rarity:"common",description:"The final abyss predator. Abyssspider exists in the space between shadows. You only know it's there when it's too late.",
   stats:{hp:126,atk:131,def:75,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"oblivirach",name:"Oblivirach",emoji:"🕷️",type:"Dark",rarity:"common",description:"Abyrach past the point where shadows are needed. It hunts in the gaps of memory; witnesses recall nothing, twice.",
   stats:{hp:163,atk:171,def:97,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"shadowtoad",name:"Nyctoad",emoji:"🐸",type:"Dark",rarity:"common",description:"Voidtoad's final form. A darkness incarnate — wherever Shadowtoad is, light simply ceases to function.",
   ...
   abilities:{
     ...
     special:{name:"Shadow Abyss",charge:8,upgrades:["Abyss cloud; -40% all enemy stats 6s; silence 3s; can't gain buffs in cloud","-50%","-60%","-72%","-84%; silence 4s; all abilities silenced; drain 20 HP/s in cloud"]},
   ...
   },role:"Attacker",attackType:"Melee",evolutionOf:"voidtoad",shardsToAscend:22,ascensionsToEvolve:45,evolutionId:"erebotoad"},
  {id:"erebotoad",name:"Erebotoad",emoji:"🌑",type:"Dark",rarity:"common",description:"Nyctoad, once the last light finished going out. Astronomers keep finding it in photographs of nothing.",
   stats:{hp:159,atk:166,def:120,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Erebus Tongue",upgrades:["20 dmg+drain 14 HP+silence","26 dmg","33 dmg","42 dmg","Drain 22+silence 1.5s+strip 2 buffs"]},
     special:{name:"Event Horizon",charge:8,upgrades:["Abyss cloud; -50% all enemy stats 6s; silence 3s; no buffs in cloud","-60%","-72%","-86%","-100%; silence 5s; drain 28 HP/s in cloud"]},
     unique:{name:"Final Dark",upgrades:["Passive: 42% of dmg dealt heals; kills absorb 2 buffs","46%; absorb 3 buffs","52%; absorb all buffs","60%; absorb all buffs+skills","70%; Erebotoad immune to all light dmg+blind; revives twice growing stronger each time"]}
   },role:"Attacker",attackType:"Melee",evolutionOf:"shadowtoad",shardsToAscend:28,ascensionsToEvolve:null},
  // Dark line 3
  {id:"wraithworm",name:"Wraithworm",emoji:"🐛",type:"Dark",rarity:"common",description:"A translucent dark caterpillar that phases through solid matter. Not malicious, just deeply unsettling.",
   stats:{hp:57,atk:58,def:31,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"phantomworm",name:"Spectriworm",emoji:"🐛",type:"Dark",rarity:"common",description:"Wraithworm evolved into a spectral serpent. It exists only partially in this dimension and fully in chaos.",
   stats:{hp:85,atk:87,def:48,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"voidwyrm",name:"Vacumamba",emoji:"🐉",type:"Dark",rarity:"common",description:"Phantomworm's draconic final form. Voidwyrm doesn't exist in any fixed location — it appears wherever it decides to strike.",
   stats:{hp:116,atk:119,def:65,spd:1,abilitySpeed:1},
   abilities:{
     ...
     special:{name:"Void Shift",charge:20,upgrades:["Vanish all fight; reappear at will; strike for 90 dmg+crit+silence 2s","108 dmg","130 dmg","156 dmg","Strike is undodgeable; applies full void web; strip all buffs from target"]},
   ...
   },role:"Attacker",attackType:"Melee",evolutionOf:"phantomworm",shardsToAscend:22,ascensionsToEvolve:45,evolutionId:"nihilmamba"},
  {id:"nihilmamba",name:"Nihilmamba",emoji:"🐍",type:"Dark",rarity:"common",description:"Vacumamba refined to a single principle: things it bites stop being things. Philosophers refuse to study it further.",
   stats:{hp:151,atk:155,def:84,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Nihil Fang",upgrades:["23 dmg; ignore 38% DEF+silence 1s","29 dmg","37 dmg","47 dmg","Ignore 48% DEF+silence 1.5s+strip 2 buffs"]},
     special:{name:"Unmake",charge:20,upgrades:["Vanish; reappear at will; strike for 115 dmg+crit+silence 2.5s","138 dmg","165 dmg","198 dmg","Strike is undodgeable; strips all buffs; target loses 10% max HP"]},
     unique:{name:"Nonexistence",upgrades:["Passive: 50% phase-negate; attacks ignore 55% DEF; counter 100 dmg; invisible between actions","Ignore 65%; counter 125","Ignore 76%; counter 152","Ignore 88%; counter 185","Ignore 100%; counter 225; Nihilmamba cannot be damaged while phasing; revives once fully healed+invisible"]}
   },role:"Attacker",attackType:"Melee",evolutionOf:"voidwyrm",shardsToAscend:28,ascensionsToEvolve:null},
  {id:"magmavore",name:"Magmavore",emoji:"🌋",type:"Fire",rarity:"epic",description:"Born inside a volcano, it feeds on molten rock and spits lava at those who dare approach.",
   stats:{hp:100,atk:70,def:75,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"pyroclaw",name:"Pyroclaw",emoji:"🌋",type:"Fire",rarity:"epic",description:"Magmavore's molten middle form. Its claws bore through bedrock for fun. Geologists call the aftermath 'intimate.'",
   stats:{hp:138,atk:95,def:102,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Lava Spit",upgrades:["22 dmg + burn pool","30 dmg","38 dmg","50 dmg","Pool lasts 5s and deals 12 dmg/s"]},
     special:{name:"Eruption Shield",charge:18,upgrades:["Ring deals 25 dmg","Ring 35 dmg","Ring 45 dmg","Ring 55 dmg","Ring also grants +25 DEF while active"]},
   ...
   stats:{hp:162,atk:112,def:121,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Lava Spit",upgrades:["22 dmg + burn pool","30 dmg","38 dmg","50 dmg","Pool lasts 5s and deals 12 dmg/s"]},
     special:{name:"Eruption Shield",charge:18,upgrades:["Ring deals 25 dmg","Ring 35 dmg","Ring 45 dmg","Ring 55 dmg","Ring also grants +25 DEF while active"]},
  ...
  {id:"shadowstrike",name:"Shadowstrike",emoji:"🐈‍⬛",type:"Dark",rarity:"epic",description:"A wraith-like cat that phases through walls and strikes from the shadows.",
   stats:{hp:80,atk:83,def:47,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"phantomfang",name:"Phantomfang",emoji:"🐈‍⬛",type:"Dark",rarity:"epic",description:"Shadowstrike halfway dissolved into the void. Half-cat, half-shadow, fully committed to ruining your day.",
   stats:{hp:102,atk:106,def:59,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Shadow Swipe",upgrades:["28 dmg","38 dmg","48 dmg","60 dmg","Always crits when attacking from stealth"]},
     special:{name:"Phase Step",charge:10,upgrades:["Dodge next hit","Dodge + 15 dmg counter","Dodge + 22 dmg counter","Dodge + 30 dmg counter","Phase Step also enters stealth for 2s after dodge"]},
   ...
   stats:{hp:117,atk:121,def:67,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"salamagma",name:"Salamagma",emoji:"🦎",type:"Fire",rarity:"epic",description:"A lava salamander the size of a bus. Scientists describe it as 'extremely hot and very angry.'",
   stats:{hp:102,atk:65,def:108,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"ignadon",name:"Ignadon",emoji:"🦎",type:"Fire",rarity:"epic",description:"Salamagma's scales have hardened to igneous rock. It no longer moves â€” it erupts from place to place.",
   stats:{hp:140,atk:89,def:148,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Magma Bite",upgrades:["18 dmg+burn 5/s 3s","23 dmg","30 dmg","38 dmg","Burn 8/s 4s; attackers burned 3s"]},
     special:{name:"Lava Coat",charge:22,upgrades:["DEF+70+thorns burn 20/s 4s","DEF+90","DEF+115+thorns 25/s","DEF+140","DEF+170; thorns 30/s; immune to freeze/slow"]},
   ...
   stats:{hp:165,atk:105,def:175,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"blazehornet",name:"Emberstar",emoji:"⭐",type:"Fire",rarity:"epic",description:"A starfish that washed onto a lava flow and simply kept walking. Its five arms glow like heating elements.",
   stats:{hp:77,atk:79,def:42,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Twin Barb",upgrades:["20 dmg 2 times.","21 dmg each","3 hits; 21 dmg each","3 hits; 23 dmg each","4 hits; 23 dmg each"]},
     special:{name:"Charging Pierce",charge:20,upgrades:["70 dmg.","74 dmg","74 dmg; increased damage range","81 dmg; increased damage range","81 dmg; increased damage range; leaves behind a temporary fire trail, damaging enemies it touches"]},
  ...
  {id:"infernohive",name:"Magmastar",emoji:"🌟",type:"Fire",rarity:"epic",description:"Emberstar's arms have hardened into vents of molten rock. Wherever it rests, the seafloor starts smoking.",
   stats:{hp:107,atk:108,def:57,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Twin Barb",upgrades:["20 dmg 2 times.","21 dmg each","3 hits; 21 dmg each","3 hits; 23 dmg each","4 hits; 23 dmg each"]},
     special:{name:"Charging Pierce",charge:20,upgrades:["70 dmg.","74 dmg","74 dmg; increased damage range","81 dmg; increased damage range","81 dmg; increased damage range; leaves behind a temporary fire trail, damaging enemies it touches"]},
   ...
   stats:{hp:125,atk:128,def:67,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Twin Barb",upgrades:["20 dmg 2 times.","21 dmg each","3 hits; 21 dmg each","3 hits; 23 dmg each","4 hits; 23 dmg each"]},
     special:{name:"Charging Pierce",charge:20,upgrades:["105 dmg.","111 dmg","111 dmg; increased damage range","122 dmg; increased damage range","122 dmg; increased damage range; leaves behind a larger, longer-lasting fire trail, damaging enemies it touches"]},
  ...
  {id:"coralleviathan",name:"Nessling",emoji:"🦕",type:"Water",rarity:"epic",description:"A long-necked lake serpent barely the size of a rowboat. Already extremely difficult to photograph.",
   stats:{hp:122,atk:62,def:97,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"tidecrush",name:"Lochcoil",emoji:"🦕",type:"Water",rarity:"epic",description:"Nessling grown into a chain of humps that surface one at a time. Nine separate expeditions have logged it as a floating tree.",
   stats:{hp:167,atk:85,def:133,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Loch Spout",upgrades:["14 dmg","16 dmg","18 dmg","21 dmg","21 dmg and inflict Haste Down"]},
     special:{name:"Deep Submerge",charge:30,upgrades:["Heal 40 HP; 30 dmg and Taunt them","Heal 50 HP; 30 dmg and Taunt them","Heal 62 HP; 30 dmg and Taunt them","Heal 75 HP; 30 dmg and Taunt them","Heal 75 HP; 30 dmg, and inflict Attack Down and Taunt."]},
     unique:{name:"Stirring Depths",upgrades:["Gain 0.5 Ability Charge when damaged","Gain 1 Ability Charge when damaged","Gain 1.5 Ability Charge when damaged","Gain 2 Ability Charge when damaged","Gain 2.5 Ability Charge when damaged"]}
   ...
   stats:{hp:197,atk:101,def:157,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Loch Spout",upgrades:["14 dmg","16 dmg","18 dmg","21 dmg","21 dmg and inflict Haste Down"]},
     special:{name:"Deep Submerge",charge:30,upgrades:["Heal 40 HP; 30 dmg and Taunt them","Heal 50 HP; 30 dmg and Taunt them","Heal 62 HP; 30 dmg and Taunt them","Heal 75 HP; 30 dmg and Taunt them","Heal 75 HP; 30 dmg, and inflict Attack Down and Taunt."]},
     unique:{name:"Stirring Depths",upgrades:["Gain 0.5 Ability Charge when damaged","Gain 1 Ability Charge when damaged","Gain 1.5 Ability Charge when damaged","Gain 2 Ability Charge when damaged","Gain 2.5 Ability Charge when damaged"]}
  ...
  {id:"frostadder",name:"Frostadder",emoji:"🐍",type:"Water",rarity:"epic",description:"A viper whose venom has been replaced by liquid nitrogen. Every bite is a small ice age.",
   stats:{hp:83,atk:84,def:45,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"glaciafang",name:"Glaciafang",emoji:"🐍",type:"Water",rarity:"epic",description:"Frostadder grown enormous, its scales fused into solid ice plates. Every bite drops the temperature by 20 degrees.",
   stats:{hp:113,atk:116,def:62,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Ice Fang",upgrades:["20 dmg+freeze 8% 1s","26 dmg","33 dmg","42 dmg","Freeze 15% 1.5s; frozen foes take +20% dmg"]},
     special:{name:"Cryo Strike",charge:18,upgrades:["70 dmg+freeze 2s+shatter 40 dmg","85 dmg","104 dmg","126 dmg","Freeze 2.5s; shatter 60 dmg; strip 1 buff"]},
   ...
   stats:{hp:133,atk:136,def:74,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"stormjelly",name:"Stormjelly",emoji:"🪼",type:"Water",rarity:"epic",description:"A storm-charged jellyfish that floats in the upper atmosphere. Its tentacles conduct lightning into rain.",
   stats:{hp:77,atk:50,def:49,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"tempestjelly",name:"Tempestjelly",emoji:"🪼",type:"Water",rarity:"epic",description:"Stormjelly grown vast and crackling. Its glow can be seen from the ocean floor. Sailors call it a 'sky reef.'",
   stats:{hp:104,atk:69,def:68,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Shock Sting",upgrades:["12 dmg; shock+slow 15% 2s","15 dmg","19 dmg","25 dmg","Shock+slow 22% 2.5s; heal 1 ally 10 HP"]},
     special:{name:"Storm Veil",charge:10,upgrades:["Shield all allies 55 HP+12% dodge 5s","Shield 72; 16%","Shield 90; 20%","Shield 110; 25%","Shield 135; 30%; also grant lightning-immune 4s"]},
   ...
   stats:{hp:123,atk:81,def:79,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"verdantboa",name:"Viriboa",emoji:"🐍",type:"Nature",rarity:"epic",description:"A boa constrictor grown from the world tree itself. What it wraps around becomes part of the forest.",
   stats:{hp:82,atk:86,def:48,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"thorncoil",name:"Thorncoil",emoji:"🐍",type:"Nature",rarity:"epic",description:"Verdantboa's scales have hardened into bark-like wood. What it wraps around becomes mulch, then forest.",
   stats:{hp:112,atk:117,def:66,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Vine Strike",upgrades:["18 dmg+root 0.5s+poison 5/s 2s","23 dmg","30 dmg","38 dmg","Root 1s+poison 8/s 3s; rooted foes +15% dmg taken"]},
     special:{name:"Constrict",charge:14,upgrades:["Constrict; 75 dmg+DEF-20% 5s+poison 6/s 4s","90 dmg","108 dmg","130 dmg","Also silence 2s; constricted foes can't use abilities"]},
   ...
   stats:{hp:132,atk:138,def:78,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"mossgolem",name:"Sporolith",emoji:"🧱",type:"Nature",rarity:"epic",description:"A golem built by the forest itself from centuries of accumulated moss. It is very slow and profoundly unkillable.",
   stats:{hp:129,atk:65,def:98,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"stonewarden",name:"Stonewarden",emoji:"🧱",type:"Nature",rarity:"epic",description:"Mossgolem's moss compressed into dense stone. It is slower now, and roughly five times harder to kill.",
   stats:{hp:176,atk:89,def:134,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Moss Slam",upgrades:["14 dmg; stagger 0.5s; heal 1 ally 18 HP","18 dmg","23 dmg","30 dmg","Stagger 1s; heal all allies 10 HP"]},
     special:{name:"Living Moss",charge:10,upgrades:["Aura; all allies +20 HP/s 6s+DEF+40","Regen 28/s; DEF+55","Regen 36/s; DEF+72","Regen 46/s; DEF+90","Regen 58/s; DEF+110; also remove all debuffs from all allies"]},
   ...
   stats:{hp:208,atk:104,def:158,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"venomfiend",name:"Venomfiend",emoji:"🐸",type:"Nature",rarity:"epic",description:"A toad whose skin secretes a venom so potent it dissolved its own classification in the biology textbooks.",
   stats:{hp:65,atk:55,def:68,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"blighttoad",name:"Blighttoad",emoji:"🐸",type:"Nature",rarity:"epic",description:"Venomfiend's venom has become semi-sentient. It selects its own targets now. Biologists have filed for early retirement.",
   stats:{hp:89,atk:75,def:92,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Toxic Spit",upgrades:["14 dmg; poison 7/s 3s+slow 18%","18 dmg","23 dmg","30 dmg","Poison 10/s 4s+slow 25%; spreads to 1 nearby"]},
     special:{name:"Plague Cloud",charge:22,upgrades:["Cloud; poison 8/s 5s; -25% ATK+SPD all in cloud","Poison 11/s","Poison 14/s","Poison 18/s","Poison 22/s 6s; silence 2s; can't gain buffs in cloud"]},
   ...
   stats:{hp:105,atk:88,def:108,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"crystalcrab",name:"Crystalcrab",emoji:"🦀",type:"Earth",rarity:"epic",description:"A crab whose shell has grown into perfect gemstone crystal. It is the only creature that is also a geological landmark.",
   stats:{hp:122,atk:62,def:94,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"gemcrab",name:"Gemcrab",emoji:"🦀",type:"Earth",rarity:"epic",description:"Crystalcrab's shell has grown into massive prismatic plates. Enemies go blind. Allies feel unreasonably safe.",
   stats:{hp:168,atk:84,def:128,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Crystal Claw",upgrades:["14 dmg","16 dmg","18 dmg","20 dmg","23 dmg"]},
     special:{name:"Taunting Snap",charge:10,upgrades:["26 dmg","29 dmg","33 dmg","38 dmg","38 dmg"]},
     unique:{name:"Prism Shell",upgrades:["Reflect 3% of the damage inflicted onto this creature","Reflect 6% of the damage inflicted onto this creature","Reflect 9% of the damage inflicted onto this creature","Reflect 12% of the damage inflicted onto this creature","Reflect 15% of the damage inflicted onto this creature"]}
  ...
  {id:"gemtitan",name:"Gemtitan",emoji:"🦀",type:"Earth",rarity:"epic",description:"Crystalcrab's titan form. It is now its own mountain range and is frankly unreasonable about taking damage.",
   stats:{hp:197,atk:100,def:152,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Crystal Claw",upgrades:["14 dmg","16 dmg","18 dmg","20 dmg","23 dmg"]},
     special:{name:"Taunting Snap",charge:10,upgrades:["26 dmg","29 dmg","33 dmg","38 dmg","38 dmg"]},
     unique:{name:"Prism Shell",upgrades:["Reflect 3% of the damage inflicted onto this creature","Reflect 6% of the damage inflicted onto this creature","Reflect 9% of the damage inflicted onto this creature","Reflect 12% of the damage inflicted onto this creature","Reflect 15% of the damage inflicted onto this creature"]}
  ...
  {id:"terradrake",name:"Terrauana",emoji:"🦎",type:"Earth",rarity:"epic",description:"A rock-armored drake that was literally born from a landslide. It considers earthquakes 'light stretching.'",
   stats:{hp:88,atk:93,def:54,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"rockjaw",name:"Rockjaw",emoji:"🦎",type:"Earth",rarity:"epic",description:"Terradrake's scales crystallized into jagged quartz. It doesn't bite so much as it excavates targets.",
   stats:{hp:120,atk:127,def:73,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Terra Bite",upgrades:["18 dmg+DEF-8% 3s+stagger 0.5s","23 dmg","30 dmg","38 dmg","DEF-12% 4s+stagger 1s; shockwave nearby 30 dmg"]},
     special:{name:"Seismic Slam",charge:12,upgrades:["85 dmg; quake 3s 20/s","102 dmg","123 dmg","148 dmg","Quake 5s 28/s; pillars hit all; fissures trap 2s"]},
   ...
   stats:{hp:142,atk:149,def:86,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"seismichog",name:"Seismichog",emoji:"🦔",type:"Earth",rarity:"epic",description:"A hedgehog whose quills have become tectonic plates. Hugging it is not recommended by anyone.",
   stats:{hp:112,atk:59,def:97,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"quakequill",name:"Quakequill",emoji:"🦔",type:"Earth",rarity:"epic",description:"Seismichog's quills have grown dense as bedrock. Touching one causes a localized earthquake. Locals have adapted.",
   stats:{hp:152,atk:81,def:134,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Quill Spike",upgrades:["14 dmg+thorn 20 return; DEF-8%","18 dmg","23 dmg","30 dmg","Thorn 30 return; DEF-12%; stagger 0.5s"]},
     special:{name:"Quill Curl",charge:22,upgrades:["Retract; -55% dmg 3s+thorns 35/s; emerge 70 dmg","Reduce 65%","Reduce 75%","Reduce 85%","Reduce 85%; immune 2s; emerge 120 dmg+stun 1s+knock all back"]},
   ...
   stats:{hp:179,atk:95,def:159,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"galeserpent",name:"Coatlet",emoji:"🐍",type:"Wind",rarity:"epic",description:"A small serpent growing its first quetzal feathers. It practices flying by falling off progressively taller rocks.",
   stats:{hp:77,atk:78,def:42,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"vortexserpent",name:"Plumecoatl",emoji:"🪶",type:"Wind",rarity:"epic",description:"Half snake, half bird, entirely convinced it invented the wind. Its molted feathers are collected as currency in three villages.",
   stats:{hp:105,atk:108,def:57,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Plume Dart",upgrades:["16 dmg and they lose -.5% Defense (max 50%)","21 dmg and they lose -.5% Defense (max 50%)","27 dmg and they lose -.5% Defense (max 50%)","34 dmg and they lose -.5% Defense (max 50%)","34 dmg and they lose -1% Defense (max 50%)"]},
     special:{name:"Feathered Gale",charge:14,upgrades:["55 dmg","68 dmg","84 dmg","102 dmg","102 dmg and inflict Defense Down"]},
     unique:{name:"Rising Star",upgrades:["Gain +1% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used","Gain +2% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used","Gain +3% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used","Gain +4% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used","Gain +5% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used"]}
  ...
  {id:"cyclonwyrm",name:"Quetzalis",emoji:"🐉",type:"Wind",rarity:"epic",description:"The feathered serpent of legend. It taught mortals astronomy, agriculture, and letters, then left before anyone could schedule a follow-up.",
   stats:{hp:124,atk:127,def:67,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Plume Dart",upgrades:["16 dmg and they lose -.5% Defense (max 50%)","21 dmg and they lose -.5% Defense (max 50%)","27 dmg and they lose -.5% Defense (max 50%)","34 dmg and they lose -.5% Defense (max 50%)","34 dmg and they lose -1% Defense (max 50%)"]},
     special:{name:"Feathered Gale",charge:14,upgrades:["55 dmg","68 dmg","84 dmg","102 dmg","102 dmg and inflict Defense Down"]},
     unique:{name:"Rising Star",upgrades:["Gain +1% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used","Gain +2% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used","Gain +3% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used","Gain +4% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used","Gain +5% Attack and Speed whenever an enemy is hit by Feathered Gale until the next time Feathered Gale is used"]}
  ...
  {id:"stormsurger",name:"Tempesthawk",emoji:"🦅",type:"Wind",rarity:"epic",description:"A hawk that surfed a supercell storm into existence. It doesn't fly so much as it weaponizes the atmosphere.",
   stats:{hp:78,atk:79,def:42,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"thundertalon",name:"Thundertalon",emoji:"🦅",type:"Wind",rarity:"epic",description:"Tempesthawk so electrically charged it ionizes the air around it. Clouds follow it like groupies. It does not notice.",
   ...
   stats:{hp:126,atk:128,def:67,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"galelocust",name:"Galelocust",emoji:"🦗",type:"Wind",rarity:"epic",description:"A locust whose wing-beats generate gusts strong enough to strip paint. Farmers consider it a natural disaster.",
   stats:{hp:78,atk:80,def:42,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"swarmrider",name:"Swarmrider",emoji:"🦗",type:"Wind",rarity:"epic",description:"A larger, angrier locust. Each wingbeat punches through reinforced concrete. Farmers have moved to other planets.",
   stats:{hp:107,atk:109,def:58,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Wind Slash",upgrades:["18 dmg+push; hit all in path","23 dmg","30 dmg","38 dmg","Push+slow 22% 2s; hit all in path; leave wind trail 1.5s"]},
     special:{name:"Swarm Rush",charge:8,upgrades:["Multiply to 5; dash through all foes 20 dmg each","26 dmg each","33 dmg each","42 dmg each","7 swarm clones; each knock back; merge into 1 causing 80 dmg explosion"]},
   ...
   stats:{hp:126,atk:128,def:68,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"voltdrake",name:"Voltimon",emoji:"🦎",type:"Electric",rarity:"epic",description:"A lizard that evolved inside a thundercloud. It does not understand why other creatures fear storms.",
   stats:{hp:83,atk:85,def:47,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"stormscale",name:"Stormscale",emoji:"🦎",type:"Electric",rarity:"epic",description:"Voltdrake's lightning scales have arced together into living electricity. It bites and the arc does the rest.",
   stats:{hp:113,atk:117,def:64,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Thunder Bite",upgrades:["20 dmg+arc to 2 foes 50%+paralyze 15% 1s","26 dmg","33 dmg","42 dmg","Arc 3 foes 65%; paralyze 22% 1.5s; stun 0.5s on paralyze"]},
     special:{name:"Volt Surge",charge:22,upgrades:["85 dmg+stun 1s; chain to all nearby","102 dmg","123 dmg","148 dmg","Chain ignores DEF; stun 1.5s; each chained foe -25% SPD 4s"]},
   ...
   stats:{hp:134,atk:138,def:75,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"boltfly",name:"Boltfly",emoji:"🦟",type:"Electric",rarity:"epic",description:"A mosquito-sized bolt of lightning that has decided it wants to be a mosquito. Fast, annoying, and 100,000 volts.",
   stats:{hp:76,atk:77,def:41,spd:1,abilitySpeed:1},
   abilities:{
     ...
     special:{name:"Volt Dash",charge:10,upgrades:["Teleport to foe; 72 dmg+stun 1s+paralyze 2s","87 dmg","105 dmg","126 dmg","Stun 1.5s; paralyze 2.5s; shockwave 50 dmg on arrival to all nearby"]},
   ...
   },role:"Attacker",attackType:"Ranged",shardsToAscend:15,ascensionsToEvolve:10,evolutionId:"arcbolt"},
  {id:"arcbolt",name:"Arcbolt",emoji:"🦟",type:"Electric",rarity:"epic",description:"Boltfly condensed into a faster, angrier bolt of itself. 500,000 volts and proud of it. Power grids file complaints.",
   stats:{hp:104,atk:106,def:56,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Shock Pierce",upgrades:["18 dmg; ignore 20% DEF+paralyze 18% 1s","23 dmg","30 dmg","38 dmg","Ignore 28% DEF; paralyze 26% 1.5s; arc to 2 nearby"]},
     special:{name:"Volt Dash",charge:10,upgrades:["Teleport to foe; 72 dmg+stun 1s+paralyze 2s","87 dmg","105 dmg","126 dmg","Stun 1.5s; paralyze 2.5s; shockwave 50 dmg on arrival to all nearby"]},
   ...
   },role:"Attacker",attackType:"Ranged",evolutionOf:"boltfly",shardsToAscend:18,ascensionsToEvolve:25,evolutionId:"zapdragon"},  {id:"zapdragon",name:"Voltray",emoji:"🐲",type:"Electric",rarity:"epic",description:"Boltfly evolved into a dragon of pure electrical current. Power grids within 10 miles behave erratically.",
   stats:{hp:123,atk:125,def:66,spd:1,abilitySpeed:1},
   abilities:{
     ...
     special:{name:"Dragon Volt",charge:20,upgrades:["Teleport to foe; 110 dmg+stun 1.5s+paralyze all nearby 2.5s; shockwave 80 dmg all","132 dmg","158 dmg","190 dmg","Stun 2s; paralyze 3s; shockwave stuns all nearby 1s; strip all buffs"]},
  ...
  {id:"shockcrab",name:"Shockstinger",emoji:"🦂",type:"Electric",rarity:"epic",description:"A scorpion that stores charge in its tail like a living capacitor. Desert electricians keep their distance.",
   stats:{hp:118,atk:61,def:96,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"voltcrusher",name:"Voltlasher",emoji:"🦂",type:"Electric",rarity:"epic",description:"Shockstinger's charges have built to dangerous levels. Every segment of its tail is a live wire. The power company has sent a letter.",
   stats:{hp:162,atk:83,def:132,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Volt Sting",upgrades:["14 dmg and inflict 1 stack of Restrained","18 dmg and inflict 1 stack of Restrained","23 dmg and inflict 1 stack of Restrained","30 dmg and inflict 1 stack of Restrained","30 dmg and inflict 2 stacks of Restrained"]},
     special:{name:"Overload Sting",upgrades:["45 dmg","52 dmg","60 dmg","70 dmg","70 dmg. This creature gains Speed Up"]},
     unique:{name:"Static Grip",upgrades:["Enemies with Restrained have -2% Speed","Enemies with Restrained have -4% Speed","Enemies with Restrained have -6% Speed","Enemies with Restrained have -8% Speed","Enemies with Restrained have -10% Speed"]}
   ...
   stats:{hp:191,atk:98,def:156,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Volt Sting",upgrades:["14 dmg and inflict 1 stack of Restrained","18 dmg and inflict 1 stack of Restrained","23 dmg and inflict 1 stack of Restrained","30 dmg and inflict 1 stack of Restrained","30 dmg and inflict 2 stacks of Restrained"]},
     special:{name:"Overload Sting",upgrades:["45 dmg","52 dmg","60 dmg","70 dmg","70 dmg. This creature gains Speed Up"]},
     unique:{name:"Static Grip",upgrades:["Enemies with Restrained have -2% Speed","Enemies with Restrained have -4% Speed","Enemies with Restrained have -6% Speed","Enemies with Restrained have -8% Speed","Enemies with Restrained have -10% Speed"]}
  ...
  {id:"solardrake",name:"Solardrake",emoji:"🦎",type:"Light",rarity:"epic",description:"A drake that basks directly in the sun's core and considers it 'mild.' Its scales emit light that heals.",
   stats:{hp:84,atk:87,def:49,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"lumadrak",name:"Lumadrak",emoji:"🦎",type:"Light",rarity:"epic",description:"Solardrake whose scales now emit constant healing light. Enemy medics have lodged formal protests with the council.",
   stats:{hp:115,atk:119,def:67,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Solar Beam",upgrades:["20 dmg+blind 20% 1.5s; heal 1 ally 14 HP","26 dmg","33 dmg","42 dmg","Blind 28% 2s; heal all allies 8 HP; arc 1 nearby"]},
     special:{name:"Solar Flare",charge:22,upgrades:["88 dmg; blind all 2.5s; heal all allies 40 HP","106 dmg","128 dmg","154 dmg","Blind 3.5s; heal 65 HP; grant all allies +18% ATK+DEF 4s"]},
   ...
   stats:{hp:135,atk:141,def:79,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"sacredwasp",name:"Starlit",emoji:"🐝",type:"Light",rarity:"epic",description:"A wasp whose stinger delivers blessing instead of venom. Theology departments find it very confusing.",
   stats:{hp:71,atk:47,def:47,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"divinedrone",name:"Starbright",emoji:"🐝",type:"Light",rarity:"epic",description:"A wasp so sacred the concept of harm has agreed to avoid it. It stings with pure blessings. Theologians are keeping notes.",
   stats:{hp:97,atk:65,def:65,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Piercing Blessing",upgrades:["10 dmg","10 dmg","11 dmg","11 dmg; enemy hit: -10% Haste for 3s","11 dmg; enemy hit: -10% Haste for 3s; ally hit: +10% Haste for 3s"]},
     special:{name:"Radiant Exchange",charge:20,upgrades:["18 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s","20 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s","22 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s","22 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s and recover HP","22 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s and recover HP"]},
     unique:{name:"Starlit Wings",upgrades:["Gain 20% Speed and +2 Range; if Emberstar is on the field, both gain +10% ATK","Gain 20% Speed and +2 Range; if Emberstar is on the field, both gain +20% ATK","Gain 20% Speed and +2 Range; if Emberstar is on the field, both gain +30% ATK","Gain 20% Speed and +2 Range; if Emberstar is on the field, both gain +40% ATK","Gain 50% Speed and +2 Range; if Emberstar is on the field, both gain +40% ATK"]}
   ...
   stats:{hp:115,atk:77,def:76,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Piercing Blessing",upgrades:["10 dmg","10 dmg","11 dmg","11 dmg; enemy hit: -10% Haste for 3s","11 dmg; enemy hit: -10% Haste for 3s; ally hit: +10% Haste for 3s"]},
     special:{name:"Radiant Exchange",charge:20,upgrades:["18 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s","20 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s","22 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s","22 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s and recover HP","22 dmg; enemy hit: -15% ATK for 3s; ally hit: +15% ATK for 3s and recover HP"]},
     unique:{name:"Starlit Wings",upgrades:["Gain 20% Speed and +2 Range; if Emberstar is on the field, both gain +10% ATK","Gain 20% Speed and +2 Range; if Emberstar is on the field, both gain +20% ATK","Gain 20% Speed and +2 Range; if Emberstar is on the field, both gain +30% ATK","Gain 20% Speed and +2 Range; if Emberstar is on the field, both gain +40% ATK","Gain 50% Speed and +2 Range; if Emberstar is on the field, both gain +40% ATK"]}
  ...
  {id:"lumigator",name:"Lumigator",emoji:"🦎",type:"Light",rarity:"epic",description:"A massive albino alligator that glows from within. It was protecting a sacred pool of light. Now it protects everything.",
   stats:{hp:109,atk:56,def:88,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"gleamgator",name:"Gleamgator",emoji:"🦎",type:"Light",rarity:"epic",description:"Lumigator's glow has intensified. Nearby enemies go blind. Nearby allies feel inexplicably at peace with everything.",
   stats:{hp:150,atk:77,def:121,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Light Bite",upgrades:["14 dmg; blind 15% 1s; heal self+1 ally 16 HP","18 dmg","23 dmg","30 dmg","Blind 22% 1.5s; heal all allies 10 HP; DEF-10% on target"]},
     special:{name:"Sacred Shell",charge:16,upgrades:["DEF+80+regen 15/s+blind aura 20% 5s; allies -18% dmg taken","DEF+102","DEF+128; aura 26%","DEF+158","DEF+192; aura 32%; allies -28% dmg; immune to blind"]},
   ...
   stats:{hp:177,atk:91,def:144,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"eclipseboa",name:"Eclipseboa",emoji:"🐍",type:"Dark",rarity:"epic",description:"A massive boa that swallows light itself. Where it passes, even fire goes out.",
   stats:{hp:85,atk:88,def:48,spd:1,abilitySpeed:1},
   abilities:{
     ...
     special:{name:"Shadow Coil",charge:22,upgrades:["Constrict; 80 dmg+silence 3s+drain 15/s 4s+DEF-22%","96 dmg","116 dmg","140 dmg","Silence 4s; drain 22/s; DEF-30%; strip all buffs; can't gain buffs while constricted"]},
   ...
   },role:"Attacker",attackType:"Melee",shardsToAscend:15,ascensionsToEvolve:10,evolutionId:"voidboa"},
  {id:"voidboa",name:"Voidboa",emoji:"🐍",type:"Dark",rarity:"epic",description:"Eclipseboa grown twice as long and twice as dark. It has begun sprouting additional heads. Each one has opinions.",
   stats:{hp:116,atk:120,def:66,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Eclipse Bite",upgrades:["20 dmg+silence 0.5s+drain 10 HP","26 dmg","33 dmg","42 dmg","Silence 1s; drain 15 HP; strip 1 buff"]},
     special:{name:"Shadow Coil",charge:22,upgrades:["Constrict; 80 dmg+silence 3s+drain 15/s 4s+DEF-22%","96 dmg","116 dmg","140 dmg","Silence 4s; drain 22/s; DEF-30%; strip all buffs; can't gain buffs while constricted"]},
   ...
   },role:"Attacker",attackType:"Melee",evolutionOf:"eclipseboa",shardsToAscend:18,ascensionsToEvolve:25,evolutionId:"darkhydra"},  {id:"darkhydra",name:"Eclipsemaw",emoji:"🐲",type:"Dark",rarity:"epic",description:"Eclipseboa grew multiple heads and an attitude problem. Each head operates independently and all of them are hungry.",
   stats:{hp:137,atk:142,def:78,spd:1,abilitySpeed:1},
   abilities:{
     ...
     special:{name:"Hydra Coil",charge:18,upgrades:["All 3 heads constrict a foe each; 100 dmg+silence 4s+drain 25/s","120 dmg","145 dmg","175 dmg","Silence 5s; drain 38/s; DEF-40%; can't gain buffs; strip all buffs; if only 1 foe then 1 head takes 3x"]},
  ...
  {id:"doomgrub",name:"Doomshade",emoji:"👻",type:"Dark",rarity:"legendary",description:"A spectre that drifted out of a lantern festival centuries ago and never went back. It hands out little flames to anyone who gets close. The flames are load-bearing.",
   stats:{hp:155,atk:79,def:122,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"nihilwyrm",name:"Nihilgeist",emoji:"☠️",type:"Dark",rarity:"legendary",description:"Doomshade with nothing left to haunt except the concept of light itself. Its wisps no longer flicker. They wait.",
   stats:{hp:186,atk:95,def:147,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Spectral Rake",upgrades:["12 dmg","15 dmg","19 dmg","24 dmg","24 dmg and inflict Damage Over Time"]},
     special:{name:"Grave Lantern",charge:16,upgrades:["If there are less than 2 Wisps, summon 1 Wisp with 25 Health.","If there are less than 2 Wisps, summon 1 Wisp with 32 Health.","If there are less than 2 Wisps, summon 1 Wisp with 40 Health.","If there are less than 2 Wisps, summon 1 Wisp with 50 Health.","If there are less than 2 Wisps, summon 1 Wisp with 50 Health. It gains 100% Ability Charge."]},
     unique:{name:"Lantern Keeper",upgrades:["Summon 1 Wisp with 25 Health and it gains 100% Ability Charge.","Summon 1 Wisp with 32 Health and it gains 100% Ability Charge.","Summon 1 Wisp with 40 Health and it gains 100% Ability Charge.","Summon 1 Wisp with 50 Health and it gains 100% Ability Charge.","Summon 2 Wisps with 50 Health and they gain 100% Ability Charge."]}
  ...
  {id:"stormwyvern",name:"Stormwyvern",emoji:"🐉",type:"Wind",rarity:"legendary",description:"Ancient ruler of storm clouds. Its wingspan generates hurricanes.",
   stats:{hp:113,atk:103,def:87,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"tempestlord",name:"Tempestlord",emoji:"🌪️",type:"Wind",rarity:"legendary",description:"The storm given eternal form. Where Tempestlord passes, the age of clear skies ends permanently.",
   stats:{hp:135,atk:124,def:105,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"nebulalux",name:"Nebulalux",emoji:"🌌",type:"Light",rarity:"legendary",description:"Celestialux absorbed an entire nebula. It now contains more light than a small galaxy and shares all of it.",
   stats:{hp:134,atk:123,def:103,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"blazephoenix",name:"Blazephoenix",emoji:"🦅",type:"Fire",rarity:"legendary",description:"A phoenix hatched from the heart of a dying star. It considers extinction and rebirth a perfectly normal Tuesday.",
   stats:{hp:109,atk:112,def:61,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"solarpyre",name:"Solarpyre",emoji:"🌟",type:"Fire",rarity:"legendary",description:"Blazephoenix's true form. A solar storm wearing feathers. Astronomers have filed formal complaints.",
   stats:{hp:130,atk:134,def:74,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"ignisdragon",name:"Ignissaur",emoji:"🐲",type:"Fire",rarity:"legendary",description:"A dragon forged in the earth's mantle and never told it could leave. Surprisingly well-adjusted about it.",
   stats:{hp:116,atk:125,def:77,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"pyredragon",name:"Pyresaur",emoji:"🐉",type:"Fire",rarity:"legendary",description:"Ignisdragon fully ignited. Every scale is a miniature sun. Sunglasses are not sufficient protection.",
   stats:{hp:140,atk:150,def:92,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Magma Fang",upgrades:["30 dmg","34 dmg","38 dmg","43 dmg","43 dmg and inflict Burn"]},
     special:{name:"Inferno Breath",charge:8,upgrades:["55 dmg","62 dmg","70 dmg","80 dmg","80 dmg and inflict Burn"]},
     unique:{name:"Stoked Flames",upgrades:["Deals 1% extra damage for each stack of Burn on the enemy","Deals 2% extra damage for each stack of Burn on the enemy","Deals 3% extra damage for each stack of Burn on the enemy","Deals 4% extra damage for each stack of Burn on the enemy","Deals 5% extra damage for each stack of Burn on the enemy"]}
  ...
  {id:"magmatitan",name:"Magmaur",emoji:"🦣",type:"Fire",rarity:"legendary",description:"A creature so massive it reroutes lava flows. Geologists refer to it in hushed, reverent tones.",
   stats:{hp:168,atk:87,def:136,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"infernocolossus",name:"Infernocolossus",emoji:"🌋",type:"Fire",rarity:"legendary",description:"Magmatitan evolved past the concept of cooling down. It is now classified as an active geological event.",
   stats:{hp:202,atk:104,def:164,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"frosthydra",name:"Waddlepop",emoji:"🐧",type:"Water",rarity:"common",description:"A round penguin that lobs suspiciously ticking snowballs. It packs them itself and takes no questions.",
   stats:{hp:48,atk:50,def:28,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"glacialhydra",name:"Frostillery",emoji:"🐧",type:"Water",rarity:"common",description:"Waddlepop upgraded to full siege capability. It carries an entire bandolier of ice bombs and considers every problem a targeting solution.",
   stats:{hp:96,atk:100,def:56,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Ice Lob",upgrades:["12 dmg","14 dmg","16 dmg","18 dmg","18 dmg and inflict Speed Down"]},
     special:{name:"Cryo Bomb",charge:12,upgrades:["24 dmg","28 dmg","32 dmg","37 dmg","37 dmg. Inflicts Frostbite"]},
     unique:{name:"Snowball Effect",upgrades:["Cryo Bomb deals 2% more damage whenever it's used (max 100%)","Cryo Bomb deals 4% more damage whenever it's used (max 100%)","Cryo Bomb deals 6% more damage whenever it's used (max 100%)","Cryo Bomb deals 8% more damage whenever it's used (max 100%)","Cryo Bomb deals 10% more damage whenever it's used (max 100%)"]}
  ...
  {id:"bombardguin",name:"Bombardguin",emoji:"🐧",type:"Water",rarity:"common",description:"Frostillery with proper mortar training. It calculates arcs on one flipper and never misses twice.",
   stats:{hp:120,atk:125,def:70,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Ice Lob",upgrades:["12 dmg","14 dmg","16 dmg","18 dmg","18 dmg and inflict Speed Down"]},
     special:{name:"Cryo Bomb",charge:12,upgrades:["24 dmg","28 dmg","32 dmg","37 dmg","37 dmg. Inflicts Frostbite"]},
     unique:{name:"Snowball Effect",upgrades:["Cryo Bomb deals 2% more damage whenever it's used (max 100%)","Cryo Bomb deals 4% more damage whenever it's used (max 100%)","Cryo Bomb deals 6% more damage whenever it's used (max 100%)","Cryo Bomb deals 8% more damage whenever it's used (max 100%)","Cryo Bomb deals 10% more damage whenever it's used (max 100%)"]}
  ...
  {id:"cryogeddon",name:"Cryogeddon",emoji:"🧊",type:"Water",rarity:"common",description:"The penguin at the end of winter. Its bombardments have their own entry in the glacier fossil record.",
   stats:{hp:144,atk:150,def:84,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Ice Lob",upgrades:["12 dmg","14 dmg","16 dmg","18 dmg","18 dmg and inflict Speed Down"]},
     special:{name:"Cryo Bomb",charge:12,upgrades:["24 dmg","28 dmg","32 dmg","37 dmg","37 dmg. Inflicts Frostbite"]},
     unique:{name:"Snowball Effect",upgrades:["Cryo Bomb deals 2% more damage whenever it's used (max 100%)","Cryo Bomb deals 4% more damage whenever it's used (max 100%)","Cryo Bomb deals 6% more damage whenever it's used (max 100%)","Cryo Bomb deals 8% more damage whenever it's used (max 100%)","Cryo Bomb deals 10% more damage whenever it's used (max 100%)"]}
  ...
  {id:"abyssraken",name:"Abyssraken",emoji:"🦑",type:"Water",rarity:"legendary",description:"The original kraken. Every sea monster myth traces back to this. It is mildly annoyed by the inaccuracies.",
   stats:{hp:157,atk:81,def:127,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"deepkraken",name:"Bathykraken",emoji:"🦑",type:"Water",rarity:"legendary",description:"Abyssraken grown to its true size. Oceans look small standing next to it. It considers this 'a tight fit.'",
   stats:{hp:189,atk:97,def:152,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"oceanwyrm",name:"Tidalwarden",emoji:"🐍",type:"Water",rarity:"legendary",description:"A serpent old enough to remember when the oceans were young. It helped fill them.",
   stats:{hp:105,atk:109,def:60,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"tidaldragon",name:"Tidalorca",emoji:"🐉",type:"Water",rarity:"legendary",description:"Oceanwyrm's draconic final form. Every ocean current on the planet follows its movements.",
   stats:{hp:127,atk:131,def:72,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"verdanthydra",name:"Thornwarden",emoji:"🐲",type:"Nature",rarity:"legendary",description:"A hydra grown from the world tree's roots. Each head controls a different forest. All of them are poisonous.",
   stats:{hp:129,atk:99,def:127,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"roothydra",name:"Worldthorn",emoji:"🐉",type:"Nature",rarity:"legendary",description:"Verdanthydra evolved into the world forest itself. Every tree on the planet is technically its body now.",
   stats:{hp:156,atk:118,def:152,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"sylvandragon",name:"Sylviguana",emoji:"🦎",type:"Nature",rarity:"legendary",description:"A dragon that tends the great forests and considers itself their gardener. Its pruning method involves venom.",
   stats:{hp:107,atk:112,def:63,spd:1,abilitySpeed:1},
   abilities:{
     ...
     special:{name:"Ancient Venom",charge:18,upgrades:["Inject: foe gains max poison stacks+root 3s; 100 dmg over duration","120 dmg","145 dmg","175 dmg","Max stacks; root 4s; poison can't be cured; spread to all nearby of target"]},
  ...
  {id:"ancientdragon",name:"Primordrus",emoji:"🐉",type:"Nature",rarity:"legendary",description:"Sylvandragon become the ancient forest. It is both creature and ecosystem. Taxonomists have given up.",
   stats:{hp:129,atk:134,def:75,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"bloomphoenix",name:"Bloomibis",emoji:"🦉",type:"Nature",rarity:"legendary",description:"A cat-faced owl crowned with living antlers. Whatever it watches over simply refuses to stay hurt.",
   stats:{hp:107,atk:70,def:67,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"lifephoenix",name:"Animavis",emoji:"🌿",type:"Nature",rarity:"legendary",description:"Bloomphoenix's final form. The concept of life given wings. It sustains ecosystems just by existing nearby.",
   stats:{hp:127,atk:84,def:81,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Antler Dart",upgrades:["16 dmg","18 dmg","20 dmg","23 dmg","23 dmg. +5% Attack to self on hit (stacking) until the next time Soothing Hoot is used"]},
     special:{name:"Soothing Hoot",charge:22,upgrades:["Heal 38 HP","Heal 48 HP","Heal 60 HP","Heal 75 HP","Heal 75 HP. Also cleanses all debuffs from healed allies"]},
     unique:{name:"Guardian Grove",upgrades:["Heal 6 HP/s","Heal 8 HP/s","Heal 10 HP/s","Heal 13 HP/s","Heal 13 HP/s and gain +10% Attack"]}
  ...
  {id:"earthgolem",name:"Terravast",emoji:"🗿",type:"Earth",rarity:"legendary",description:"Built by an ancient civilization as a guardian. The civilization is gone. Earthgolem is still guarding.",
   stats:{hp:175,atk:89,def:135,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"titangolem",name:"Terralith",emoji:"🏔️",type:"Earth",rarity:"legendary",description:"Earthgolem grew until it became the mountain. Geographers debate whether it counts as topography.",
   stats:{hp:211,atk:106,def:161,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"quartzhydra",name:"Geoloch",emoji:"💎",type:"Earth",rarity:"legendary",description:"A gemstone hydra that grew inside the earth's crystal core. Each head is a different precious stone.",
   stats:{hp:141,atk:106,def:131,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"gemhydra",name:"Prismarex",emoji:"🐉",type:"Earth",rarity:"legendary",description:"Quartzhydra fully crystalized. An eight-headed dragon of pure gemstone. It is its own mountain, treasury, and fortress.",
   stats:{hp:169,atk:127,def:158,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"seismicdrake",name:"Richterdrake",emoji:"🦎",type:"Earth",rarity:"legendary",description:"A drake whose heartbeat registers as seismic activity. It thinks the world shaking is how everyone says hello.",
   stats:{hp:108,atk:117,def:71,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"quakewyrm",name:"Seismarex",emoji:"🐉",type:"Earth",rarity:"legendary",description:"Seismicdrake's final form. A tectonic wyrm so massive that continents shift when it turns around.",
   stats:{hp:131,atk:140,def:85,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"galephoenix",name:"Aetherwing",emoji:"🕊️",type:"Wind",rarity:"legendary",description:"A phoenix reborn in the eye of a hurricane. It considers Category 5 storms 'brisk.' ",
   stats:{hp:103,atk:106,def:57,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"skyphoenix",name:"Skyphoenix",emoji:"✨",type:"Wind",rarity:"legendary",description:"Galephoenix's true form. A creature of pure atmospheric power that rewrites the rules of weather by existing.",
   stats:{hp:123,atk:127,def:68,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"cyclonedrake",name:"Maelstrake",emoji:"🦅",type:"Wind",rarity:"legendary",description:"A drake born inside a cyclone and raised by the wind. It has never once touched the ground and considers this normal.",
   stats:{hp:96,atk:99,def:53,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"vortexwyrm",name:"Maelstrix",emoji:"🐉",type:"Wind",rarity:"legendary",description:"Cyclonedrake's final form. A wyrm of living wind that exists simultaneously everywhere the wind blows.",
   stats:{hp:115,atk:119,def:64,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"thunderhydra",name:"Voltravene",emoji:"⚡",type:"Electric",rarity:"legendary",description:"A hydra with a head for every type of lightning. Scientists documented it once. Their equipment never worked again.",
   stats:{hp:110,atk:121,def:80,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"stormhydra",name:"Arcmajor",emoji:"🐉",type:"Electric",rarity:"legendary",description:"Thunderhydra's final form. Nine heads, nine storms. Meteorologists have collectively retired.",
   stats:{hp:132,atk:146,def:96,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"voltphoenix",name:"Arcsurge",emoji:"🦅",type:"Electric",rarity:"legendary",description:"A phoenix that died in a lightning bolt and came back as one. Power grids nationwide have filed grievances.",
   stats:{hp:102,atk:105,def:57,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"arcphoenix",name:"Arcondor",emoji:"🌩️",type:"Electric",rarity:"legendary",description:"Voltphoenix's true form. Pure electricity given feathers and a bad attitude toward things that conduct poorly.",
   stats:{hp:122,atk:126,def:68,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"galvanigolem",name:"Galvatus",emoji:"🤖",type:"Electric",rarity:"legendary",description:"An ancient war golem rebuilt with a lightning core. Its builders are long gone. It is still very much operational.",
   stats:{hp:169,atk:86,def:133,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"staticgolem",name:"Arcvast",emoji:"🌩️",type:"Electric",rarity:"legendary",description:"Galvanigolem's final form. A walking thunderstorm in metal armor. Nations have tried to weaponize it. Nations have failed.",
   stats:{hp:203,atk:103,def:160,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"solarphoenix",name:"Dawnwing",emoji:"🔥",type:"Light",rarity:"legendary",description:"A phoenix made of solar plasma. It exists at the intersection of light, heat, and 'please don't look directly at it.'",
   stats:{hp:111,atk:96,def:71,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"divinephoenix",name:"Celestialis",emoji:"☀️",type:"Light",rarity:"legendary",description:"Solarphoenix ascended to true divinity. It can no longer be described using standard luminosity measurements.",
   stats:{hp:133,atk:116,def:85,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"holydragon",name:"Auravast",emoji:"🐲",type:"Light",rarity:"legendary",description:"A dragon born in a beam of divine light. It guards sacred places and heals anyone who approaches. Even enemies.",
   stats:{hp:154,atk:79,def:122,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"celestialdragon",name:"Lumimajor",emoji:"🐉",type:"Light",rarity:"legendary",description:"Holydragon's celestial final form. A dragon of pure starlight and divine grace. Its very presence is a blessing.",
   stats:{hp:186,atk:94,def:146,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"voidhydra",name:"Abyssmaw",emoji:"🐲",type:"Dark",rarity:"legendary",description:"A hydra that feeds on the void between stars. Each head has eaten a different constellation and is still hungry.",
   stats:{hp:114,atk:124,def:80,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"nihilhydra",name:"Nullravene",emoji:"🐉",type:"Dark",rarity:"legendary",description:"Voidhydra's final form. The nothing between galaxies given nine heads and a purpose. The purpose is unclear. It is likely terrible.",
   stats:{hp:136,atk:149,def:97,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"darkphoenix",name:"Umbravex",emoji:"🦅",type:"Dark",rarity:"legendary",description:"A phoenix that died in the void and came back wrong. It still heals — the void just considers it 'anti-life.'",
   stats:{hp:103,atk:107,def:58,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"oblivionphoenix",name:"Nihilvour",emoji:"🌑",type:"Dark",rarity:"legendary",description:"Darkphoenix's true form. Oblivion given wings. The concept of light files a restraining order and loses.",
   stats:{hp:124,atk:128,def:70,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"abyssgolem",name:"Loptrix",emoji:"🦊",type:"Dark",rarity:"legendary",description:"A fox that is never quite where you last saw it. It has been formally banished from four separate pantheons, which it regards as a personal best.",
   stats:{hp:114,atk:101,def:79,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"nihilgolem",name:"Ragnavix",emoji:"🌘",type:"Dark",rarity:"legendary",description:"Loptrix at the height of its mischief, no longer bothering to hold a single shape. It once talked an entire army into fighting itself and left before anyone noticed. Nothing has ever been proven.",
   stats:{hp:136,atk:122,def:95,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Mocking Nip",upgrades:["20 dmg","26 dmg","33 dmg","42 dmg","42 dmg and inflict Defense Down"]},
     special:{name:"Scapegoat",charge:24,upgrades:["40 dmg","50 dmg","62 dmg","78 dmg","95 dmg"]},
     unique:{name:"Vanishing Act",upgrades:["Gain 70% Ability Charge at the start of the fight. When falling below 30% Health, teleport next to a Ranged ally if able.","Gain 80% Ability Charge at the start of the fight. When falling below 30% Health, teleport next to a Ranged ally if able.","Gain 90% Ability Charge at the start of the fight. When falling below 30% Health, teleport next to a Ranged ally if able.","Gain 100% Ability Charge at the start of the fight. When falling below 30% Health, teleport next to a Ranged ally if able.","Gain 100% Ability Charge at the start of the fight. When falling below 30% Health, teleport next to a Ranged ally if able and dispel all debuffs on self."]}
  ...
  {id:"emberchirp",name:"Emberchirp",emoji:"🐤",type:"Fire",rarity:"common",description:"A round chick that runs a slight fever at all times. It naps in campfires and wakes up offended when they go out.",
   stats:{hp:39,atk:26,def:25,spd:1,abilitySpeed:1},
   abilities:{
  ...
  {id:"pyrefinch",name:"Pyrefinch",emoji:"🐦‍🔥",type:"Fire",rarity:"common",description:"Its down has burned away into true flame feathers. Injured animals have started sleeping outside its nest, which it pretends to find annoying.",
   stats:{hp:66,atk:43,def:41,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Stolen Spark",upgrades:["Heal 4 HP; 8 dmg","Heal 4 HP; 10 dmg","Heal 4 HP; 13 dmg","Heal 4 HP; 16 dmg","Heal 6 HP; 16 dmg"]},
     special:{name:"Shared Flame",charge:12,upgrades:["Heal 20 HP","Heal 26 HP","Heal 33 HP","Heal 42 HP","Heal 42 HP. All other allies gain Heal Over Time"]},
     unique:{name:"Rekindle",upgrades:["Gain 1% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 2% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 3% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 4% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 5% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated."]}
  ...
  {id:"cauterix",name:"Cauterix",emoji:"❤️‍🔥",type:"Fire",rarity:"common",description:"It has learned to close wounds the direct way. Its patients describe the treatment as 'brief', 'effective', and 'never again', then come back anyway.",
   stats:{hp:95,atk:61,def:58,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Stolen Spark",upgrades:["Heal 4 HP; 8 dmg","Heal 4 HP; 10 dmg","Heal 4 HP; 13 dmg","Heal 4 HP; 16 dmg","Heal 6 HP; 16 dmg"]},
     special:{name:"Shared Flame",charge:12,upgrades:["Heal 20 HP","Heal 26 HP","Heal 33 HP","Heal 42 HP","Heal 42 HP. All other allies gain Heal Over Time"]},
     unique:{name:"Rekindle",upgrades:["Gain 1% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 2% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 3% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 4% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 5% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated."]}
  ...
  {id:"hearthenix",name:"Hearthenix",emoji:"🌅",type:"Fire",rarity:"common",description:"The phoenix of the hearth. Where other phoenixes are reborn from their own ashes, Hearthenix extends the courtesy to everyone else.",
   stats:{hp:125,atk:82,def:78,spd:1,abilitySpeed:1},
   abilities:{
     basic:{name:"Stolen Spark",upgrades:["Heal 4 HP; 8 dmg","Heal 4 HP; 10 dmg","Heal 4 HP; 13 dmg","Heal 4 HP; 16 dmg","Heal 6 HP; 16 dmg"]},
     special:{name:"Shared Flame",charge:12,upgrades:["Heal 20 HP","Heal 26 HP","Heal 33 HP","Heal 42 HP","Heal 42 HP. All other allies gain Heal Over Time"]},
     unique:{name:"Rekindle",upgrades:["Gain 1% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 2% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 3% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 4% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated.","Gain 5% increased Healing for each 10% missing Health. Revive with 100% Health the first time this creature is defeated."]}
...
CREATURE_MAP["__vine_minion"]={id:"__vine_minion",emoji:"🌱",name:"Vine Minion",type:"Nature",attackType:"Melee",stats:{hp:80,atk:25,def:15,spd:1,abilitySpeed:1},abilities:{basic:{name:"Vine Whip",description:"Attacks the nearest enemy"},special:{name:"Entangle",description:"Attacks all surrounding tiles"}}};

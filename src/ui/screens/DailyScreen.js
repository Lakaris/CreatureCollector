...
import { REWARD_LABELS, REWARD_DESC, DAILY_REWARDS } from "../../data/quests.js";
import { applyRewards } from "../../core/rewards.js";

function DailyScreen({onBack}){
  const { setCurrencies, dailyDay, setDailyDay, dailyLastClaimed, setDailyLastClaimed } = useGame();
  ...
  function claimDay(){
    if(!canClaim)return;
    const reward=DAILY_REWARDS[dailyDay].reward;

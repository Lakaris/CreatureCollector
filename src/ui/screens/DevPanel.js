...
function DevPanel(){
  ...
  return React.createElement("div",{className:"dev-panel"},
    ...
    devTab==="actions"&&React.createElement(React.Fragment,null,
      ...
      React.createElement("div",{className:"dev-row"},
        React.createElement("button",{className:"dev-btn",style:{width:"100%",padding:8},disabled:dungeonStarterPackPurchased,onClick:()=>purchaseBundle(STORE_BUNDLES.find(b=>b.id==="dungeon_starter_pack"))},
          dungeonStarterPackPurchased?"Dungeon Starter Pack already owned":"Buy Dungeon Starter Pack (skip Store confirm)")
      ),
      React.createElement("div",{className:"dev-row"},
